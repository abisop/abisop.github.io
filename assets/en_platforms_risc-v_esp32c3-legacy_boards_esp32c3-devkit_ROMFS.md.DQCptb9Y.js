import{_ as t,c as s,al as r,o as a}from"./chunks/framework.NFAqBSgQ.js";const u=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/risc-v/esp32c3-legacy/boards/esp32c3-devkit/ROMFS.md","filePath":"en/platforms/risc-v/esp32c3-legacy/boards/esp32c3-devkit/ROMFS.md"}'),i={name:"en/platforms/risc-v/esp32c3-legacy/boards/esp32c3-devkit/ROMFS.md"};function o(n,e,d,p,h,l){return a(),s("div",null,e[0]||(e[0]=[r(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><h2 id="overview" tabindex="-1">Overview <a class="header-anchor" href="#overview" aria-label="Permalink to &quot;Overview&quot;">​</a></h2><p>This directory contains logic to support a custom ROMFS system-init script and start-up script. These scripts are used by by the NSH when it starts provided that CONFIG_ETC_ROMFS=y. These scripts provide a ROMFS volume that will be mounted at /etc and will look like this at run-time:</p><pre><code>NuttShell (NSH) NuttX-10.1.0-RC1
...
</code></pre><p>Where: group: The group name x: Group password gid: Group ID users: A comma separated list of members of the group</p><h2 id="updating-the-romfs-file-system" tabindex="-1">Updating the ROMFS File System <a class="header-anchor" href="#updating-the-romfs-file-system" aria-label="Permalink to &quot;Updating the ROMFS File System&quot;">​</a></h2><p>The content on the nsh_romfsimg.h header file is generated from a sample directory structure. You can directly modify files under etc/ folder, The build system will regenerate nsh_romfsimg.h automatically.</p><p>See the esp32c3-devkit/nsh configuration for an example of the use of this file system.</p><h2 id="replacing-the-password-file" tabindex="-1">Replacing the Password File <a class="header-anchor" href="#replacing-the-password-file" aria-label="Permalink to &quot;Replacing the Password File&quot;">​</a></h2><p>The esp32c3-devkit/nsh configuration can also be used to create a new password file. First, make these configuration changes:</p><pre><code>1. Disable logins
