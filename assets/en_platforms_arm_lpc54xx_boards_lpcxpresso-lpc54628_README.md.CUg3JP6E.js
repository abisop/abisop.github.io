import{_ as t,c as n,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/lpc54xx/boards/lpcxpresso-lpc54628/README.md","filePath":"en/platforms/arm/lpc54xx/boards/lpcxpresso-lpc54628/README.md"}'),a={name:"en/platforms/arm/lpc54xx/boards/lpcxpresso-lpc54628/README.md"};function s(r,e,h,l,d,u){return i(),n("div",null,e[0]||(e[0]=[o(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><p>This directory contains the port to the NXP LPCXpress-LPC54628 board (OMI1309UL). This board features:</p><pre><code>- LPC54628 Cortex-M4 microcontroller running at up to 220MHz
...
</code></pre><p>The <code>&lt;subdir&gt;</code> that is provided above as an argument to the tools/configure.sh must be is one of the following.</p><p>NOTES:</p><pre><code>1. These configurations use the mconf-based configuration tool.  To
...
</code></pre><p>Configuration Sub-directories -----------------------------</p><p>fb:</p><pre><code>A simple NSH configuration used for some basic debug of LCD using the
...
4. The touchscreen test program at apps/examples/touchscreen is also
  ...
  puppy.
</code></pre><h2 id="lvgl" tabindex="-1">lvgl <a class="header-anchor" href="#lvgl" aria-label="Permalink to &quot;lvgl&quot;">​</a></h2><p>This is a demonstration of the LittlevGL graphics library running on the NuttX frame buffer driver (as in the fb configuration). You can find LittlevGL here:</p><pre><code>  https://littlevgl.com/
...
</code></pre><h2 id="netnsh" tabindex="-1">netnsh: <a class="header-anchor" href="#netnsh" aria-label="Permalink to &quot;netnsh:&quot;">​</a></h2><p>This is a special version of the NuttShell (nsh) configuration that is tailored for network testing. This version derives from nsh configuration so many of the notes there apply here except as noted below.</p><pre><code>NOTES:
...
5. In this configuration, the network the network and the Telnet
   ...
   to do:
     ...
     $ telnet fc00::42
</code></pre><p>nsh:</p><pre><code>Configures the NuttShell (nsh) application located at examples/nsh.
...
</code></pre><p>pwlines:</p><pre><code>This configuration uses the test at apps/examples/pwline.  It is another
...
</code></pre><p>twm4nx1 and twmnx2:</p><pre><code>These configuration exercises the port of TWM to NuttX.  A description of
...
</code></pre>`,40)]))}const f=t(a,[["render",s]]);export{p as __pageData,f as default};
