import{_ as o,c as t,al as n,o as i}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"ST Nucleo F746ZG","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/stm32f7/boards/nucleo-f746zg/index.md","filePath":"en/platforms/arm/stm32f7/boards/nucleo-f746zg/index.md"}'),a={name:"en/platforms/arm/stm32f7/boards/nucleo-f746zg/index.md"};function r(s,e,l,c,u,h){return i(),t("div",null,e[0]||(e[0]=[n(`<h1 id="st-nucleo-f746zg" tabindex="-1">ST Nucleo F746ZG <a class="header-anchor" href="#st-nucleo-f746zg" aria-label="Permalink to &quot;ST Nucleo F746ZG&quot;">​</a></h1><p>chip:stm32, chip:stm32f7, chip:stm32f746</p><p>This page discusses issues unique to NuttX configurations for the STMicro Nucleo-144 board. See ST document STM32 Nucleo-144 boards (UM1974):</p><p><a href="https://www.st.com/resource/en/user_manual/dm00244518.pdf" target="_blank" rel="noreferrer">https://www.st.com/resource/en/user_manual/dm00244518.pdf</a></p><h2 id="board-features" tabindex="-1">Board Features <a class="header-anchor" href="#board-features" aria-label="Permalink to &quot;Board Features&quot;">​</a></h2><ul><li>Peripherals: 8 leds, 2 push button (3 LEDs, 1 button) under software control</li><li>Debug: STLINK/V2-1 debugger/programmer Uses a STM32F103CB to provide a ST-Link for programming, debug similar to the OpenOcd FTDI function - USB to JTAG front-end.</li><li>Expansion I/F: ST Zio and Extended Arduino and Morpho Headers</li></ul><p>ST Nucleo F746ZG board from ST Micro is supported. See</p><p><a href="http://www.st.com/content/st_com/en/products/evaluation-tools/product-evaluation-tools/mcu-eval-tools/stm32-mcu-eval-tools/stm32-mcu-nucleo/nucleo-f746zg.html" target="_blank" rel="noreferrer">http://www.st.com/content/st_com/en/products/evaluation-tools/product-evaluation-tools/mcu-eval-tools/stm32-mcu-eval-tools/stm32-mcu-nucleo/nucleo-f746zg.html</a></p><p>The Nucleo F746ZG order part number is NUCLEO-F746ZG. It is one member of the STM32 Nucleo-144 board family.</p><h2 id="nucleo-f746zg-features" tabindex="-1">NUCLEO-F746ZG Features <a class="header-anchor" href="#nucleo-f746zg-features" aria-label="Permalink to &quot;NUCLEO-F746ZG Features&quot;">​</a></h2><ul><li>Microprocessor: STM32F746ZGT6 Core: ARM 32-bit Cortex®-M7 CPU with FPU, L1-cache: 4KB data cache and 4KB instruction cache, up to 216 MHz, MPU, and DSP instructions.</li><li>Memory: 1024 KB Flash 320KB of SRAM (including 64KB of data TCM RAM) <ul><li>16KB of instruction TCM RAM + 4KB of backup SRAM</li></ul></li><li>ADC:3×12-bit, 2.4 MSPS ADC: up to 24 channels and 7.2 MSPS in triple interleaved mode</li><li>DMA: 2 X 16-stream DMA controllers with FIFOs and burst support</li><li>Timers: Up to 18 timers: up to thirteen 16-bit (1x 16-bit low power), two 32-bit timers, 2x watchdogs, SysTick</li><li>GPIO: 114 I/O ports with interrupt capability</li><li>LCD: LCD-TFT Controller with (DMA2D), Parallel interface</li><li>I2C: 4 × I2C interfaces (SMBus/PMBus)</li><li>U[S]ARTs: 4 USARTs, 4 UARTs (27 Mbit/s, ISO7816 interface, LIN, IrDA, modem control)</li><li>SPI/12Ss: 6/3 (simplex) (up to 50 Mbit/s), 3 with muxed simplex I2S for audio class accuracy via internal audio PLL or external clock</li><li>QSPI: Dual mode Quad-SPI</li><li>SAIs: 2 Serial Audio Interfaces</li><li>CAN: 2 X CAN interface</li><li>SDMMC interface</li><li>SPDIFRX interface</li><li>USB: USB 2.0 full-speed device/host/OTG controller with on-chip PHY</li><li>10/100 Ethernet: MAC with dedicated DMA: supports IEEE 1588v2 hardware, MII/RMII</li><li>Camera Interface: 8/14 Bit</li><li>CRC calculation unit</li><li>TRG: True random number generator</li><li>RTC</li></ul><p>See <a href="https://developer.mbed.org/platforms/ST-Nucleo-F746ZG" target="_blank" rel="noreferrer">https://developer.mbed.org/platforms/ST-Nucleo-F746ZG</a> for additional information about this board.</p><h3 id="hardware" tabindex="-1">Hardware <a class="header-anchor" href="#hardware" aria-label="Permalink to &quot;Hardware&quot;">​</a></h3><p>GPIO - there are 144 I/O lines on the STM32F7xxZxT6 with various pins pined out on the Nucleo 144.</p><p>See <a href="https://developer.mbed.org/platforms/ST-Nucleo-F746ZG/" target="_blank" rel="noreferrer">https://developer.mbed.org/platforms/ST-Nucleo-F746ZG/</a> for slick graphic pinouts.</p><p>Keep in mind that:</p><ul><li>The I/O is 3.3 Volt not 5 Volt like on the Arduino products.</li><li>The Nucleo-144 board family has 3 pages of Solder Bridges AKA Solder Blobs (SB) that can alter the factory configuration. We will note SB in effect but will assume the factory default settings.</li></ul><p>Our main concern is establishing a console and LED utilization for debugging. Because so many pins can be multiplexed with so many functions, the above mentioned graphic may be helpful in identifying a serial port.</p><p>There are 5 choices that can be made from the menuconfig:</p><pre><code>CONFIG_NUCLEO_CONSOLE_ARDUINO or CONFIG_NUCLEO_CONSOLE_MORPHO or
...
CONFIG_ARM_TOOLCHAIN_GNU_EABI=y      : ARM GNU for Linux
</code></pre></li></ol>`,87)]))}const f=o(a,[["render",r]]);export{p as __pageData,f as default};
