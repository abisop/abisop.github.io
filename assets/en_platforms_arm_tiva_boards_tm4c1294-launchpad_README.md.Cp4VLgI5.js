import{_ as e,c as t,al as a,o}from"./chunks/framework.NFAqBSgQ.js";const c=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/tiva/boards/tm4c1294-launchpad/README.md","filePath":"en/platforms/arm/tiva/boards/tm4c1294-launchpad/README.md"}'),i={name:"en/platforms/arm/tiva/boards/tm4c1294-launchpad/README.md"};function r(s,n,h,l,d,_){return o(),t("div",null,n[0]||(n[0]=[a(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><p>This is the README file for a port of NuttX to the TM4C1294 Connected Launchpad (more correctly, the EK-TM4C1294XL). For more information about this board, see <a href="http://www.ti.com/tool/ek-tm4c1294xl" target="_blank" rel="noreferrer">http://www.ti.com/tool/ek-tm4c1294xl</a></p><h1 id="dk-tm4c129x" tabindex="-1">DK-TM4C129X <a class="header-anchor" href="#dk-tm4c129x" aria-label="Permalink to &quot;DK-TM4C129X&quot;">​</a></h1><p>This board configuration derives from the DK-T4C129X. Refer to the README file at nuttx/boards/dk-tm4c129x for additional information that may be relevant to this board as well.</p><h1 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h1><p>These configurations use UART0 for the serial console. UART0 is connected to the on-board TM4C123G-based debugger and is forwarded through the ICDI virtual UART.</p><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each EK-TM4C1294XL configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh tm4c1294-launchpad:&lt;subdir&gt;
...
</code></pre>`,16)]))}const u=e(i,[["render",r]]);export{c as __pageData,u as default};
