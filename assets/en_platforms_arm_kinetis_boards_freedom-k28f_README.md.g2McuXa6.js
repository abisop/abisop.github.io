import{_ as n,c as T,al as t,o}from"./chunks/framework.NFAqBSgQ.js";const D=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/kinetis/boards/freedom-k28f/README.md","filePath":"en/platforms/arm/kinetis/boards/freedom-k28f/README.md"}'),P={name:"en/platforms/arm/kinetis/boards/freedom-k28f/README.md"};function a(A,e,r,_,s,i){return o(),T("div",null,e[0]||(e[0]=[t(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><p>This port is for the FRDM-K28F development board that features the MK28FN2M0VMI15 MCU. The features of the FRDM-K28F board are:</p><pre><code>o Kinetis MK28FN2M0VMI15 MCU (ARM Cortex-M4 at150 MHz, 1 MB SRAM, 2 MB flash,
...
o Programmable OpenSDA v2.2 debug circuit supporting the DAP-Link interface
...
</code></pre><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><p>o STATUS o Serial Console o LEDs and Buttons o Configurations</p><h1 id="status" tabindex="-1">STATUS <a class="header-anchor" href="#status" aria-label="Permalink to &quot;STATUS&quot;">​</a></h1><p>2018-05-05: The basic NSH port appears to be fully functional. I do see one anomaly: There is a significant, long start up delay. This delay seems to be variable from immediate to several seconds. I have not studied the cause, but there are the symptoms:</p><pre><code>This debug on, I see this output after a reset:
  ...
  Builtin Apps:
  nsh&gt;
</code></pre><p>The delay occurs between the reset and the __start debug output. __start is the reset handler so this is very early in the logic. On a reset, it vectors to __start. That particular debug message is output after most low-level initialization has occurred. So the delay is something within the initialization sequence at the beginning of __start. My suspicion is the delays associated with the clock configuration.</p><h1 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h1><pre><code>----- --------------- -------------------------------
...
----- --------------- -------------------------------
</code></pre><p>Arduino RS-232 Shield ---------------------</p><pre><code>----- --------------- -------------------------------
GPIO  LPUART FUNCTION BOARD CONFIGURATION
----- --------------- -------------------------------
PTA25 LPUART2_RX      PTA25 SDHC0_D0/Arduino_D0_LPUART2_RX
PTA24 LPUART2_TX      PTA24 SDHC0_D1/Arduino_D1_LPUART2_TX
----- --------------- -------------------------------
</code></pre><p>Note: PTA24 and PTA25 are shared between Micro SD Card circuit and Arduino connectors. Remove R106 and R107 or R94 and R11 as necessary to prevent contention.</p><p>Virtual serial port -------------------</p><p>A serial port connection is available between the OpenSDA v2.2 MCU and pins PTC24 and PTC25 of the K28 MCU:</p><pre><code>----- --------------- -------------------------------
GPIO  LPUART FUNCTION BOARD CONFIGURATION
----- --------------- -------------------------------
PTC25 LPUART0_RX      PTC25 LPUART0_RX_TGTMCU
PTC24 LPUART0_TX      PTC24 LPUART0_TX_TGTMCU
----- --------------- -------------------------------
</code></pre><p>Default Console ---------------</p><pre><code>Unless otherwise noted, LPUART0 (the virtual serial port) is the console
used in all Freedom-K28F configurations.
</code></pre><h2 id="rgb-led" tabindex="-1">RGB LED <a class="header-anchor" href="#rgb-led" aria-label="Permalink to &quot;RGB LED&quot;">​</a></h2><p>An RGB LED is connected through GPIO as shown below:</p><pre><code>LED    K28
------ -------------------------------------------------------
RED    PTE6
GREEN  PTE7
BLUE   PTE8
</code></pre><p>If CONFIG_ARCH_LEDs is defined, then NuttX will control the LED on board the Freedom K28. Usage of these LEDs is defined in include/board.h and src/k28_leds.c. The following definitions describe how NuttX controls the LEDs:</p><pre><code>SYMBOL                Meaning                 LED state
                                              RED   GREEN  BLUE
-------------------  -----------------------  -----------------
...
</code></pre><h2 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h2><p>Two push button switches, SW2 and SW3, are available on the FRDM-K28F board. SW2 is connected to PTA4 and SW3 is connected to PTD0. Beside the general purpose IO function, both SW2 and SW3 can be used as a low-leakage wakeup (LLWU) source.</p><pre><code>Switch    GPIO Function
--------- ---------------------------------------------------------------
SW2       PTA4/NMI_B
SW3       PTD0/LLWU_P12
</code></pre>`,27)]))}const d=n(P,[["render",a]]);export{D as __pageData,d as default};
