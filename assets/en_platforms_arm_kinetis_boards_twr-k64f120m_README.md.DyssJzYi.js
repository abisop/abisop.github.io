import{_ as t,c as n,al as o,o as r}from"./chunks/framework.NFAqBSgQ.js";const T=JSON.parse('{"title":"README.txt","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/kinetis/boards/twr-k64f120m/README.md","filePath":"en/platforms/arm/kinetis/boards/twr-k64f120m/README.md"}'),i={name:"en/platforms/arm/kinetis/boards/twr-k64f120m/README.md"};function a(s,e,I,p,l,_){return r(),n("div",null,e[0]||(e[0]=[o(`<h1 id="readme-txt" tabindex="-1">README.txt <a class="header-anchor" href="#readme-txt" aria-label="Permalink to &quot;README.txt&quot;">​</a></h1><p>This is the README file for the port of NuttX to the Freescale Kinetis TWR-K64F120M. Refer to the Freescale web site for further information about this part:</p><p>www.nxp.com/products/sensors/accelerometers/3-axis-accelerometers/kinetis-k64-mcu-tower-system-module:TWR-K64F120M</p><p>The board may be complemented by TWR-SER which includes (among other things), an RS232 and Ethernet connections:</p><p><a href="http://www.nxp.com/pages/serial-usb-ethernet-can-rs232-485-tower-system-module:TWR-SER" target="_blank" rel="noreferrer">http://www.nxp.com/pages/serial-usb-ethernet-can-rs232-485-tower-system-module:TWR-SER</a></p><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><p>o Kinetis TWR-K64F120M Features o Kinetis TWR-K64F120M Pin Configuration</p><ul><li>On-Board Connections - Connections via the General Purpose Tower Plug-in (TWRPI) Socket - Connections via the Tower Primary Connector Side A - Connections via the Tower Primary Connector Side B - TWR-SER Serial Board Connection o LEDs o TWR-K64F120M-specific Configuration Options o Configurations</li></ul><h1 id="kinetis-twr-k64f120m-features" tabindex="-1">Kinetis TWR-K64F120M Features: <a class="header-anchor" href="#kinetis-twr-k64f120m-features" aria-label="Permalink to &quot;Kinetis TWR-K64F120M Features:&quot;">​</a></h1><p>o K64N1M in 144 MAPBGA, MK64FN1M0VMD12 o Integrated, Open-SDA serial, flash and debug through USB o SD Card Slot o MMA7660 3-axis accelerometer o Tower Plug-In (TWRPI) Socket for expansion (sensors, etc.) o Touch TWRPI Socket adds support for various capacitive touch boards (e.g. keypads, rotary dials, sliders, etc.) o Tower connectivity for access to USB, Ethernet, RS232/RS485, CAN, SPI, I²C, Flexbus, etc. o Plus: Potentiometer, 4 LEDs, 2 pushbuttons, accelerometer, RTC battery</p><h1 id="kinetis-twr-k64f120m-pin-configuration" tabindex="-1">Kinetis TWR-K64F120M Pin Configuration <a class="header-anchor" href="#kinetis-twr-k64f120m-pin-configuration" aria-label="Permalink to &quot;Kinetis TWR-K64F120M Pin Configuration&quot;">​</a></h1><p>On-Board Connections</p><hr><p>FEATURE CONNECTION PORT/PIN PIN FUNCTION</p><p>OSJTAG USB-to-serial OSJTAG Bridge RX Data PTC3 UART1_RX Bridge OSJTAG Bridge TX Data PTC4 UART1_TX SD Card Slot SD Clock PTE2 SDHC0_DCLK SD Command PTE3 SDHC0_CMD SD Data0 PTE1 SDHC0_D0 SD Data1 PTE0 SDHC0_D1 SD Data2 PTE5 SDHC0_D2 SD Data3 PTE4 SDHC0_D3 SD Card Detect PTB20 PTB20 SD Write Protect PTB21 PTB21 Micro-USB K64_MICRO_USB_DN USB0_DN K64_MICRO_USB_DP USB0_DP K64_USB_ID_J PTE12 K64_USB_FLGA PTC8 K64_USB_ENABLE PTC9 Pushbuttons SW1 (LLWU_P10) PTC6 PTC6 SW2 (RSTIN_B_R) RSTIN RESET SW3 (NMI B) PTA4 PTA4 LEDs D5 / Green LED PTE6 PTE6 D6 / Yellow LED PTE7 PTE7 D7 / Orange LED PTE8 PTE8 D9 / Blue LED PTE9 PTE9 Potentiometer Potentiometer (R526) ? ADC1_SE18 Accelerometer I2C SDA PTC11 I2C1_SDA I2C SCL PTC10 I2C1_SCL INT1 PTA6 PTA6 INT2 PTA8 PTA8</p><p>SDHC important notice: on TWR-K64F120M, R521 (close to the SD card holder) is not placed, hence WRPROTEC is always ON. Either place a 4.7KOhm resistor or change PIN config to PULLDOWN, losing Write Protect function. See twrk64.h.</p><p>Connections via the G eneral Purpose Tower Plug- in (TWRPI ) Socket</p><hr><p>FEATURE CONNECTION PORT/PIN PIN FUNCTION</p><p>General Purpose TWRPI ADC0 (J4 Pin 8) ? ADC1_SE16/ADC0_SE22 TWRPI Socket TWRPI_ADC1 (J4 Pin 9) ? ADC0_SE16/ADC0_SE21 TWRPI_ADC2 (J4 Pin 12) ? ADC1_DP0/ADC0_DP3 TWRPI_ID0 (J4 Pin 17) ? ADC0_DP0/AD1_DP3 TWRPI_ID1 (J4 Pin 18) ? ADC0_DM0/ADC1_DM3 TWRPI I2C SCL (J3 Pin 3) PTC10 I2C1_SCL TWRPI I2C SDA (J3 Pin 4) PTC11 I2C1_SDA SPI1_SOUT (J3 Pin 10) PTB16 ? SPI1_PCS0 (J3 Pin 11) PTB10 PTB10 SPI1_SCK (J3 Pin 12) PTB11 ? TWRPI_GPIO0 (J3 Pin 15) PTB3 PTB3 TWRPI GPIO1 (J3 Pin 16) PTC0 PTC0 TWRPI GPIO2 (J3 Pin 17) PTC16 PTC16 TWRPI GPIO3 (J3 Pin 18) PTC17 PTC17 TWRPI GPIO4 (J3 Pin 19) PTC18 PTC18 TWRPI GPIO5 (J3 Pin 20) PTC19 PTC19</p><p>The TWR-K64F120M features two expansion card-edge connectors that interface to the Primary and Secondary Elevator boards in a Tower system. The Primary Connector (comprised of sides A and B) is identified by a white strip. The Secondary Connector is comprised of sides C and D.</p><h1 id="twr-ser-serial-board-connection" tabindex="-1">TWR-SER Serial Board Connection <a class="header-anchor" href="#twr-ser-serial-board-connection" aria-label="Permalink to &quot;TWR-SER Serial Board Connection&quot;">​</a></h1><p>The serial board connects into the tower and then maps to the tower pins to yet other functions (see TWR-SER-SCH.pdf).</p><p>In particular it features an Ethernet port.</p><h1 id="networking-support" tabindex="-1">Networking Support <a class="header-anchor" href="#networking-support" aria-label="Permalink to &quot;Networking Support&quot;">​</a></h1><p>U2 is a 25 MHz oscillator (which may be disabled by setting J4), which clock is sent to U1. U1 has two clock output banks: 25MHz (CLKBx) and 50MHz (CLKAx). J2 (set board) is used to select the PHY clock source: 50MHz, 25MHz or CLCKOUT0 from K64. Set it to 25MHz. In order to keep synchornized the PHY clock with the K64 clock, one can set J3 (default is open) to route CLOCKIN0 either from 25MHz or 50Mhz lines. In that case, J33 (main board) will have to be removed and J32 (main board set) set to disable its 50MHz_OSC and use CLKIN0 provided by set board. J12 is by default set to RMII mode. In this case J2 should be placed to 50MHz clock Note that in MII mode, MII0_TXER is required by kinetis driver, but not connected on set board</p><h2 id="ethernet-mac-ksz8041nl-phy" tabindex="-1">Ethernet MAC/KSZ8041NL PHY -------------------------- ------------ <a class="header-anchor" href="#ethernet-mac-ksz8041nl-phy" aria-label="Permalink to &quot;Ethernet MAC/KSZ8041NL PHY -------------------------- ------------&quot;">​</a></h2><p>------------------------------ ------------------------------- KSZ8041 TWR Board Signal(s) K64F Pin Pin name Pin Signal Function MII RMII ---</p><hr><p>------------------------------ ------------------------------- 9 REFCLK CLK_SEL J2: CLOCKOUT0/25MHz/50MHz, PHY clock input PTC3/CLKOUT --- direct to PHY 11 MDIO FEC_MDIO PTB0/RMII0_MDIO/MII0_MDIO PIN_MII0_MDIO PIN_RMII0_MDIO 12 MDC FEC_MDC PTB1/RMII0_MDC/MII0_MDC PIN_MII0_MDC PIN_RMII0_MDC 13 PHYAD0 FEC_RXD3 J12: PHY Address select (pull-down if set) PTA9/MII0_RXD3 PIN_RMII0_RXD3 --- 14 PHYAD1 FEC_RXD2 J12: PHY Address select (pull-up if set) PTA10/MII0_RXD2 PIN_RMII0_RXD2 --- 15 PHYAD2 FEC_RXD1 J12: PHY Address select (pull-up if set) PTA12/RMII0_RXD1/MII0_RXD1 PIN_MII0_RXD1 PIN_RMII0_RXD1 16 DUPLEX FEC_RXD0 J12: Half-duplex (pull-down if set) PTA13/RMII0_RXD0/MII0_RXD0 PIN_MII0_RXD0 PIN_RMII0_RXD0 18 CONFIG2 FEC_RXDV J12: Loopback select (pull-up if set) PTA14/RMII0_CRS_DV/MII0_RXDV PIN_MII0_RXDV PIN_RMII0_CRS_DV 19 RXC FEC_RXCLK PTA11/MII0_RXCLK PIN_MII0_RXCLK --- 20 ISO FEC_RXER J12: Isolation mode select (pull-up if set) PTA5/RMII0_RXER/MII0_RXER PIN_MII_RXER PIN_RMII_RXER 22 TXC FEC_TXCLK PTA25/MII0_TXCLK PIN_MII0_TXCLK --- 23 TXEN FEC_TXEN PTA15/RMII0_TXEN/MII0_TXEN PIN_MII0_TXEN PIN_RMII0_TXEN 24 TXD0 FEC_TXD0 PTA16/RMII0_TXD0/MII0_TXD0 PIN_MII0_TXD0 PIN_RMII0_TXD0 25 TXD1 FEC_TXD1 PTA17/RMII0_TXD1/MII0_TXD1 PIN_MII0_TXD1 PIN_RMII0_TXD1 26 TXD2 FEC_TXD2 PTA24/MII0_TXD2 PIN_MII0_TXD2 --- 27 TXD3 FEC_TXD3 PTA26/MII0_TXD3 PIN_MII0_TXD3 --- 28 CONFIG0 FEC_COL J12: RMII select (pull-up if set) PTA29/MII0_COL PIN_MII0_COL --- 29 CONFIG1 FEC_CRS PTA27/MII0_CRS PIN_MII0_CRS --- 30 LED0 LED0/NWAYEN J12: Disable auto_negotiation (pull-down if s --- --- 31 LED1 LED1/SPEED J12: 10Mbps select (pull-down if set) --- --- --- --------</p><hr><hr><p>Networking support can be added to NSH by selecting the following configuration options.</p><p>Selecting the MAC peripheral ----------------------------</p><p>System Type -&gt; Kinetis Peripheral Support CONFIG_KINETIS_ENET=y : Enable the Ethernet MAC peripheral</p><p>System Type -&gt; Ethernet Configuration CONFIG_KINETIS_ENETNETHIFS=1 CONFIG_KINETIS_ENETNRXBUFFERS=6 CONFIG_KINETIS_ENETNTXBUFFERS=2 CONFIG_KINETIS_ENET_MDIOPULLUP=y</p><p>Networking Support CONFIG_NET=y : Enable Neworking CONFIG_NET_ETHERNET=y : Support Ethernet data link CONFIG_NET_SOCKOPTS=y : Enable socket operations CONFIG_NET_ETH_PKTSIZE=590 : Maximum packet size 1518 is more standard CONFIG_NET_ARP=y : Enable ARP CONFIG_NET_ARPTAB_SIZE=16 : ARP table size CONFIG_NET_ARP_IPIN=y : Enable ARP address harvesting CONFIG_NET_ARP_SEND=y : Send ARP request before sending data CONFIG_NET_TCP=y : Enable TCP/IP networking CONFIG_NET_TCP_WRITE_BUFFERS=y : Support TCP write-buffering CONFIG_NET_TCPBACKLOG=y : Support TCP/IP backlog CONFIG_NET_MAX_LISTENPORTS=20 : CONFIG_NET_UDP=y : Enable UDP networking CONFIG_NET_BROADCAST=y : Needed for DNS name resolution CONFIG_NET_ICMP=y : Enable ICMP networking CONFIG_NET_ICMP_SOCKET=y : Needed for NSH ping command : Defaults should be okay for other options Application Configuration -&gt; Network Utilities CONFIG_NETDB_DNSCLIENT=y : Enable host address resolution CONFIG_NETUTILS_TELNETD=y : Enable the Telnet daemon CONFIG_NETUTILS_TFTPC=y : Enable TFTP data file transfers for get and put commands CONFIG_NETUTILS_NETLIB=y : Network library support is needed CONFIG_NETUTILS_WEBCLIENT=y : Needed for wget support : Defaults should be okay for other options Application Configuration -&gt; NSH Library CONFIG_NSH_TELNET=y : Enable NSH session via Telnet CONFIG_NSH_IPADDR=0xc0a800e9 : Select a fixed IP address CONFIG_NSH_DRIPADDR=0xc0a800fe : IP address of gateway/host PC CONFIG_NSH_NETMASK=0xffffff00 : Netmask CONFIG_NSH_NOMAC=y : Need to make up a bogus MAC address : Defaults should be okay for other options</p><p>You can also enable enable the DHCPC client for networks that use dynamically assigned address:</p><p>Application Configuration -&gt; Network Utilities CONFIG_NETUTILS_DHCPC=y : Enables the DHCP client</p><p>Networking Support CONFIG_NET_UDP=y : Depends on broadcast UDP</p><p>Application Configuration -&gt; NSH Library CONFIG_NET_BROADCAST=y CONFIG_NSH_DHCPC=y : Tells NSH to use DHCPC, not : the fixed addresses</p><p>Using the network with NSH --------------------------</p><p>So what can you do with this networking support? First you see that NSH has several new network related commands:</p><pre><code>ifconfig, ifdown, ifup:  Commands to help manage your network
get and put:             TFTP file transfers
wget:                    HTML file transfers
ping:                    Check for access to peers on the network
Telnet console:          You can access the NSH remotely via telnet.
</code></pre><p>You can also enable other add on features like full FTP or a Web Server or XML RPC and others. There are also other features that you can enable like DHCP client (or server) or network name resolution.</p><p>By default, the IP address of the DK-TM4C129X will be 192.168.0.233 and it will assume that your host is the gateway and has the IP address 192.168.0.254.</p><pre><code>nsh&gt; ifconfig
eth0    Link encap:Ethernet HWaddr 16:03:60:0f:00:33 at UP
    inet addr:192.168.0.233 DRaddr:192.168.0.254 Mask:255.255.255.
</code></pre><p>You can use ping to test for connectivity to the host (Careful, Window firewalls usually block ping-related ICMP traffic).</p><p>On the host PC side, you may be able to ping the TWR-K64F120M:</p><pre><code>$ ping 192.168.0.233
...
</code></pre><p>From the target side, you may should also be able to ping the host (assuming it&#39;s IP is 192.168.0.1):</p><pre><code>nsh&gt; ping 192.168.0.1
...
nsh&gt;
</code></pre><p>You can also log into the NSH from the host PC like this:</p><pre><code>$ telnet 192.168.0.233
...
</code></pre><h1 id="leds" tabindex="-1">LEDs <a class="header-anchor" href="#leds" aria-label="Permalink to &quot;LEDs&quot;">​</a></h1><p>The TWR-K64F120M board has four LEDs labeled D5, D6, D7, D9 on the board. Usage of these LEDs is defined in include/board.h and src/up_leds.c. They are encoded as follows:</p><pre><code>SYMBOL                Meaning                  LED1*    LED2    LED3    LED4
-------------------   -----------------------  -------  ------- ------- ------
...
</code></pre><ul><li>If LED1, LED2, LED3 are statically on, then NuttX probably failed to boot and these LEDs will give you some indication of where the failure was ** The normal state is LED1 ON and LED2 faintly glowing. This faint glow is because of timer interrupts and signal that result in the LED being illuminated on a small proportion of the time. *** LED3 may even glow faintlier then LED2 while signals are processed.</li></ul><h1 id="twr-k64f120m-specific-configuration-options" tabindex="-1">TWR-K64F120M-specific Configuration Options <a class="header-anchor" href="#twr-k64f120m-specific-configuration-options" aria-label="Permalink to &quot;TWR-K64F120M-specific Configuration Options&quot;">​</a></h1><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
...
</code></pre><p>Kinetis specific device driver settings</p><pre><code>CONFIG_UARTn_SERIAL_CONSOLE - selects the UARTn (n=0..5) for the
...
</code></pre><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each TWR-K64F120M configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh twr-k64f120m:&lt;subdir&gt;
</code></pre><p>Where <code>&lt;subdir&gt;</code> is one of the following:</p><h2 id="nsh" tabindex="-1">nsh: <a class="header-anchor" href="#nsh" aria-label="Permalink to &quot;nsh:&quot;">​</a></h2><p>Configures the NuttShell (nsh) located at apps/examples/nsh. The Configuration enables only the serial interface. The serial console is on OpenSDA serial bridge. For access, use $ miniterm.py -f direct /dev/ttyACM0 115200 from Linux PC Support for the board&#39;s SDHC MicroSD card is included.</p><pre><code>NOTES:
...
</code></pre><h2 id="netnsh" tabindex="-1">netnsh: <a class="header-anchor" href="#netnsh" aria-label="Permalink to &quot;netnsh:&quot;">​</a></h2><p>This is the same config then nsh, but it adds Ethernet support with the TWR-SER card. It includes telnetd in order to access nsh from Ethernet. IP address defaults to 192.168.0.233/24.</p><pre><code>NOTES:
...
</code></pre>`,94)]))}const h=t(i,[["render",a]]);export{T as __pageData,h as default};
