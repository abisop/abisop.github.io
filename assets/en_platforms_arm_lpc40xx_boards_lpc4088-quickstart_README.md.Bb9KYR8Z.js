import{_ as n,c as t,al as o,o as a}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"README.txt","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/lpc40xx/boards/lpc4088-quickstart/README.md","filePath":"en/platforms/arm/lpc40xx/boards/lpc4088-quickstart/README.md"}'),i={name:"en/platforms/arm/lpc40xx/boards/lpc4088-quickstart/README.md"};function s(r,e,l,h,d,u){return a(),t("div",null,e[0]||(e[0]=[o(`<h1 id="readme-txt" tabindex="-1">README.txt <a class="header-anchor" href="#readme-txt" aria-label="Permalink to &quot;README.txt&quot;">​</a></h1><p>This README file discusses the port of NuttX to the Embedded Artists LPC4088 QuickStart board: See <a href="https://www.embeddedartists.com/products/lpc4088-quickstart-board/" target="_blank" rel="noreferrer">https://www.embeddedartists.com/products/lpc4088-quickstart-board/</a>. This board features the NXP LPC4088FET208 MCU.</p><h1 id="contents" tabindex="-1">CONTENTS <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;CONTENTS&quot;">​</a></h1><p>o LEDs o Buttons o Serial Console o Using OpenOCD with the Olimex ARM-USB-OCD o Loading Code with the ISP Board o Configuration</p><h1 id="leds" tabindex="-1">LEDs <a class="header-anchor" href="#leds" aria-label="Permalink to &quot;LEDs&quot;">​</a></h1><p>The LCP4088 Quickstart board has four user LEDs</p><pre><code>LED1 : Connected to P1[18]
LED2 : Connected to P0[13]
LED3 : Connected to P1[13]
LED4 : Connected to P2[19]
</code></pre><p>If CONFIG_ARCH_LEDS is not defined, then the user can control the LEDs in any way using the definitions provided in the board.h header file.</p><p>If CONFIG_ARCH_LEDs is defined, then NuttX will control the 4 LEDs on the LPC4088 QuickStart board. The following definitions describe how NuttX controls the LEDs: LED1 LED2 LED3 LED4 LED_STARTED OFF OFF OFF OFF LED_HEAPALLOCATE ON OFF OFF OFF LED_IRQSENABLED OFF ON OFF OFF LED_STACKCREATED ON ON OFF OFF LED_INIRQ LED3 glows, on while in interrupt LED_SIGNAL LED3 glows, on while in signal handler LED_ASSERTION LED3 glows, on while in assertion LED_PANIC LED3 Flashes at 2Hz LED_IDLE LED glows: ON while active; OFF while sleeping</p><h1 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h1><p>The LPC4088 QuickStart board supports a single button:</p><pre><code>USER1           : Connected to P2[10]
</code></pre><p>This can be accessed using the definitions and interfaces defined in the board.h header file.</p><h1 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h1><p>By Default, UART0 is used as the serial console in all configurations. This may be connected to your computer via an external RS-232 driver or via the onboard MBED interface.</p><p>As an option, UART1 can also be used for the serial console. You might want, to do this, for example, if you use UART0 for the ISP function and you want to use a different UART for console output. UART1 can be configured as the serial console by changing the configuration as follows:</p><pre><code>System Type:
...
</code></pre><h1 id="using-openocd-with-the-olimex-arm-usb-ocd" tabindex="-1">Using OpenOCD with the Olimex ARM-USB-OCD <a class="header-anchor" href="#using-openocd-with-the-olimex-arm-usb-ocd" aria-label="Permalink to &quot;Using OpenOCD with the Olimex ARM-USB-OCD&quot;">​</a></h1><p>Building OpenOCD under Cygwin:</p><pre><code>Refer to boards/olimex-lpc1766stk/README.txt
...
</code></pre><h2 id="nsh" tabindex="-1">nsh <a class="header-anchor" href="#nsh" aria-label="Permalink to &quot;nsh&quot;">​</a></h2><p>Configures the NuttShell (nsh) located at examples/nsh. The Configuration enables only the serial NSH interface.</p><pre><code>NOTES:
...
</code></pre>`,40)]))}const f=n(i,[["render",s]]);export{p as __pageData,f as default};
