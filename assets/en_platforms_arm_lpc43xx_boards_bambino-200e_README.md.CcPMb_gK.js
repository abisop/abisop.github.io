import{_ as n,c as t,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const C=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/lpc43xx/boards/bambino-200e/README.md","filePath":"en/platforms/arm/lpc43xx/boards/bambino-200e/README.md"}'),a={name:"en/platforms/arm/lpc43xx/boards/bambino-200e/README.md"};function r(s,e,l,d,h,_){return i(),t("div",null,e[0]||(e[0]=[o(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><p>README for NuttX port to the &quot;Bambino 200E&quot; board from Micromint USA featuring the NXP LPC4330FBD144 MCU</p><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><ul><li>Bambino 200E board</li><li>Status</li><li>Serial Console</li><li>FPU</li><li>Bambino-200e Configuration Options</li><li>Configurations</li></ul><h1 id="bambino-200e-board" tabindex="-1">Bambino 200E board <a class="header-anchor" href="#bambino-200e-board" aria-label="Permalink to &quot;Bambino 200E board&quot;">​</a></h1><p>Memory Map ----------</p><p>Block Start Length Name Address --------------------- ---------- ------ RAM 0x10000000 128K RAM2 0x10080000 72K RAMAHB 0x20000000 32K RAMAHB2 0x20008000 16K RAMAHB3 0x2000c000 16K SPIFI flash 0x1e000000 4096K</p><p>GPIO Usage: -----------</p><p>GPIO PIN SIGNAL NAME</p><hr><p>gpio3[7] - LED1 101 GPIO3[7] gpio5[5] - LED2 91 GPIO5[5] gpio0[7] - BTN1 96 GPIO0[7]</p><p>Console -------</p><p>The Bambino 200E default console is the UART1 on Gadgeteer Sockets 5 (U).</p><h1 id="status" tabindex="-1">Status <a class="header-anchor" href="#status" aria-label="Permalink to &quot;Status&quot;">​</a></h1><p>Many drivers are working (USB0 Device, Ethernet, etc), but many drivers are missing.</p><h1 id="development-environment" tabindex="-1">Development Environment <a class="header-anchor" href="#development-environment" aria-label="Permalink to &quot;Development Environment&quot;">​</a></h1><p>Either Linux or Cygwin on Windows can be used for the development environment. The source has been built only using the GNU toolchain (see below). Other toolchains will likely cause problems. Testing was performed using the Cygwin environment.</p><h1 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h1><p>The LPC4330 Xplorer does not have RS-232 drivers or serial connectors on board. USART0 and UART1 are available on J8 as follows:</p><hr><p>SIGNAL J8 PIN LPC4330FET100 PIN (TFBGA100 package)</p><hr><p>U0_TXD pin 9 F6 P6_4 U0_TXD=Alt 2 U0_RXD pin 10 F9 P6_5 U0_RXD=Alt 2 U1_TXD pin 13 H8 P1_13 U1_TXD=Alt 1 U1_RXD pin 14 J8 P1_14 U1_RXD=Alt 1</p><hr><p>GND is available on J8 pin 1 5V is available on J8 pin 2 VBAT is available on J8 pin 3</p><h1 id="fpu" tabindex="-1">FPU <a class="header-anchor" href="#fpu" aria-label="Permalink to &quot;FPU&quot;">​</a></h1><h2 id="fpu-configuration-options" tabindex="-1">FPU Configuration Options <a class="header-anchor" href="#fpu-configuration-options" aria-label="Permalink to &quot;FPU Configuration Options&quot;">​</a></h2><p>There are two version of the FPU support built into the most NuttX Cortex-M4 ports.</p><ol><li><p>Non-Lazy Floating Point Register Save</p><p>In this configuration floating point register save and restore is implemented on interrupt entry and return, respectively. In this case, you may use floating point operations for interrupt handling logic if necessary. This FPU behavior logic is enabled by default with:</p><p>CONFIG_ARCH_FPU=y</p></li><li><p>Lazy Floating Point Register Save.</p><p>An alternative implementation only saves and restores FPU registers only on context switches. This means: (1) floating point registers are not stored on each context switch and, hence, possibly better interrupt performance. But, (2) since floating point registers are not saved, you cannot use floating point operations within interrupt handlers.</p><p>This logic can be enabled by simply adding the following to your .config file:</p><p>CONFIG_ARCH_FPU=y</p></li></ol><h1 id="bambino-200e-configuration-options" tabindex="-1">Bambino-200e Configuration Options <a class="header-anchor" href="#bambino-200e-configuration-options" aria-label="Permalink to &quot;Bambino-200e Configuration Options&quot;">​</a></h1><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
...
</code></pre><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each Bambino-200e configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh bambino-200e:&lt;subdir&gt;
</code></pre><p>Where <code>&lt;subdir&gt;</code> is one of the following:</p><p>knsh: -----</p><pre><code>This is identical to the nsh configuration below except that NuttX
...
</code></pre><h2 id="netnsh" tabindex="-1">netnsh: <a class="header-anchor" href="#netnsh" aria-label="Permalink to &quot;netnsh:&quot;">​</a></h2><p>Configures the NuttShell (nsh) located at examples/nsh. This configuration is focused on network testing.</p><h2 id="nsh" tabindex="-1">nsh: <a class="header-anchor" href="#nsh" aria-label="Permalink to &quot;nsh:&quot;">​</a></h2><p>This configuration is the NuttShell (NSH) example at examples/nsh/.</p><pre><code>NOTES:
...
</code></pre><p>usbnsh: -------</p><pre><code>This is another NSH example.  If differs from other &#39;nsh&#39; configurations
...
</code></pre>`,52)]))}const c=n(a,[["render",r]]);export{C as __pageData,c as default};
