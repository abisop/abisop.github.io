import{_ as o,c as n,al as t,o as a}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"ST Nucleo F722ZE","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/stm32f7/boards/nucleo-f722ze/index.md","filePath":"en/platforms/arm/stm32f7/boards/nucleo-f722ze/index.md"}'),i={name:"en/platforms/arm/stm32f7/boards/nucleo-f722ze/index.md"};function r(s,e,l,h,c,u){return a(),n("div",null,e[0]||(e[0]=[t(`<h1 id="st-nucleo-f722ze" tabindex="-1">ST Nucleo F722ZE <a class="header-anchor" href="#st-nucleo-f722ze" aria-label="Permalink to &quot;ST Nucleo F722ZE&quot;">​</a></h1><p>chip:stm32, chip:stm32f7, chip:stm32f722</p><p>This page discusses issues unique to NuttX configurations for the STMicro Nucleo-144 board. See ST document STM32 Nucleo-144 boards (UM1974):</p><p><a href="https://www.st.com/resource/en/user_manual/dm00244518.pdf" target="_blank" rel="noreferrer">https://www.st.com/resource/en/user_manual/dm00244518.pdf</a></p><h2 id="board-features" tabindex="-1">Board Features <a class="header-anchor" href="#board-features" aria-label="Permalink to &quot;Board Features&quot;">​</a></h2><ul><li>Peripherals: 8 leds, 2 push button (3 LEDs, 1 button) under software control</li><li>Debug: STLINK/V2-1 debugger/programmer Uses a STM32F103CB to provide a ST-Link for programming, debug similar to the OpenOcd FTDI function - USB to JTAG front-end.</li><li>Expansion I/F: ST Zio and Extended Arduino and Morpho Headers</li></ul><h3 id="hardware" tabindex="-1">Hardware <a class="header-anchor" href="#hardware" aria-label="Permalink to &quot;Hardware&quot;">​</a></h3><p>GPIO - there are 144 I/O lines on the STM32F7xxZxT6 with various pins pined out on the Nucleo 144.</p><p>See <a href="https://developer.mbed.org/platforms/ST-Nucleo-F746ZG/" target="_blank" rel="noreferrer">https://developer.mbed.org/platforms/ST-Nucleo-F746ZG/</a> for slick graphic pinouts.</p><p>Keep in mind that:</p><ul><li>The I/O is 3.3 Volt not 5 Volt like on the Arduino products.</li><li>The Nucleo-144 board family has 3 pages of Solder Bridges AKA Solder Blobs (SB) that can alter the factory configuration. We will note SB in effect but will assume the factory default settings.</li></ul><p>Our main concern is establishing a console and LED utilization for debugging. Because so many pins can be multiplexed with so many functions, the above mentioned graphic may be helpful in identifying a serial port.</p><p>There are 5 choices that can be made from the menuconfig:</p><pre><code>CONFIG_NUCLEO_CONSOLE_ARDUINO or CONFIG_NUCLEO_CONSOLE_MORPHO or
...
CONFIG_ARM_TOOLCHAIN_GNU_EABI=y      : ARM GNU for Linux
</code></pre></li></ol>`,81)]))}const O=o(i,[["render",r]]);export{p as __pageData,O as default};
