import{_ as o,c as n,al as t,o as a}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"ST Nucleo F091RC","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/stm32f0/boards/nucleo-f091rc/index.md","filePath":"en/platforms/arm/stm32f0/boards/nucleo-f091rc/index.md"}'),i={name:"en/platforms/arm/stm32f0/boards/nucleo-f091rc/index.md"};function r(s,e,l,d,c,u){return a(),n("div",null,e[0]||(e[0]=[t(`<h1 id="st-nucleo-f091rc" tabindex="-1">ST Nucleo F091RC <a class="header-anchor" href="#st-nucleo-f091rc" aria-label="Permalink to &quot;ST Nucleo F091RC&quot;">​</a></h1><p>chip:stm32, chip:stm32f0, chip:stm32f091</p><p>That board features the STM32F091RCT6 MCU with 256KiB of FLASH and 32KiB of SRAM.</p><h2 id="leds" tabindex="-1">LEDs <a class="header-anchor" href="#leds" aria-label="Permalink to &quot;LEDs&quot;">​</a></h2><p>The Nucleo-64 board has one user controllable LED, User LD2. This green LED is a user LED connected to Arduino signal D13 corresponding to STM32 I/O PA5 (PB13 on other some other Nucleo-64 boards).</p><ul><li>When the I/O is HIGH value, the LED is on</li><li>When the I/O is LOW, the LED is off</li></ul><p>These LEDs are not used by the board port unless CONFIG_ARCH_LEDS is defined. In that case, the usage by the board port is defined in include/board.h and src/stm32_autoleds.c. The LEDs are used to encode OS-related events as follows when the red LED (PE24) is available:</p><blockquote><p>SYMBOL Meaning LD2</p><hr><p>LED_STARTED NuttX has been started OFF LED_HEAPALLOCATE Heap has been allocated OFF LED_IRQSENABLED Interrupts enabled OFF LED_STACKCREATED Idle stack created ON LED_INIRQ In an interrupt No change LED_SIGNAL In a signal handler No change LED_ASSERTION An assertion failed No change LED_PANIC The system has crashed Blinking LED_IDLE MCU is is sleep mode Not used</p></blockquote><p>Thus if LD2, NuttX has successfully booted and is, apparently, running normally. If LD2 is flashing at approximately 2Hz, then a fatal error has been detected and the system has halted.</p><h2 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h2><p>B1 USER: the user button is connected to the I/O PC13 (pin 2) of the STM32 microcontroller.</p><h2 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h2><h3 id="usart1" tabindex="-1">USART1 <a class="header-anchor" href="#usart1" aria-label="Permalink to &quot;USART1&quot;">​</a></h3><p>Pins and Connectors:</p><pre><code>RXD: PA10  D3  CN9 pin 3, CN10 pin 33
     PB7                  CN7  pin 21
TXD: PA9   D8  CN5 pin 1, CN10 pin 21
     PB6   D10 CN5 pin 3, CN10 pin 17
</code></pre><p>NOTE: You may need to edit the include/board.h to select different USART1 pin selections.</p><p>TTL to RS-232 converter connection:</p><blockquote><p>Nucleo CN10 STM32F091RC</p><hr><p>Pin 21 PA9 USART1_TX Pin 33 PA10 Pin 20 GND Pin 8 U5V USART1_RX</p></blockquote><p>Warning: you make need to reverse RX/TX on some RS-232 converters</p><p>To configure USART1 as the console:</p><pre><code>CONFIG_STM32_USART1=y
...
TXD: PA2
     PA14
     PD5
</code></pre><h3 id="usart3" tabindex="-1">USART3 <a class="header-anchor" href="#usart3" aria-label="Permalink to &quot;USART3&quot;">​</a></h3><p>Pins and Connectors:</p><pre><code>RXD: PB11 To be provided
     PC5
     PC11
     D9
TXD: PB10
