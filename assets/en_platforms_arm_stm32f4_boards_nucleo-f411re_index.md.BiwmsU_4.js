import{_ as n,c as t,al as o,o as a}from"./chunks/framework.NFAqBSgQ.js";const h=JSON.parse('{"title":"ST Nucleo F411RE","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/stm32f4/boards/nucleo-f411re/index.md","filePath":"en/platforms/arm/stm32f4/boards/nucleo-f411re/index.md"}'),i={name:"en/platforms/arm/stm32f4/boards/nucleo-f411re/index.md"};function r(l,e,s,d,u,c){return a(),t("div",null,e[0]||(e[0]=[o(`<h1 id="st-nucleo-f411re" tabindex="-1">ST Nucleo F411RE <a class="header-anchor" href="#st-nucleo-f411re" aria-label="Permalink to &quot;ST Nucleo F411RE&quot;">​</a></h1><p>chip:stm32, chip:stm32f4, chip:stm32f411</p><p>This page discusses issues unique to NuttX configurations for the ST NucleoF411RE board from ST Micro. See</p><blockquote><p><a href="http://www.st.com/web/catalog/mmc/FM141/SC1169/SS1577/LN1877/PF260049" target="_blank" rel="noreferrer">http://www.st.com/web/catalog/mmc/FM141/SC1169/SS1577/LN1877/PF260049</a></p></blockquote><p>NucleoF411RE:</p><ul><li>Microprocessor: 32-bit ARM Cortex M4 at 100MHz STM32F411RE</li><li>Memory: 512 KB Flash and 128 KB SRAM</li><li>ADC: 1×12-bit, 2.4 MSPS A/D converter: up to 10 channels</li><li>DMA: 16-stream DMA controllers with FIFOs and burst support</li><li>Timers: Up to 11 timers: up to six 16-bit, two 32-bit timers, two watchdog timers, and a SysTick timer</li><li>GPIO: Up to 81 I/O ports with interrupt capability</li><li>I2C: Up to 3 × I2C interfaces</li><li>USARTs: Up to 3 USARTs</li><li>SPIs: Up to 4 SPIs (2 I2S)</li><li>SDIO interface</li><li>USB: USB 2.0 full-speed device/host/OTG controller with on-chip PHY</li><li>CRC calculation unit</li><li>RTC</li></ul><p>Board features, however, are identical:</p><ul><li>Peripherals: 1 led, 1 push button</li><li>Debug: Serial wire debug and JTAG interfaces</li><li>Expansion I/F Ardino and Morpho Headers</li></ul><p>Uses a STM32F103 to provide a ST-Link for programming, debug similar to the OpenOcd FTDI function - USB to JTAG front-end.</p><p>See <a href="http://developer.mbed.org/platforms/ST-Nucleo-F411RE" target="_blank" rel="noreferrer">http://developer.mbed.org/platforms/ST-Nucleo-F411RE</a> for more information about these boards.</p><h2 id="mbed" tabindex="-1">mbed <a class="header-anchor" href="#mbed" aria-label="Permalink to &quot;mbed&quot;">​</a></h2><p>The Nucleo-F411RE includes boot loader from mbed:</p><blockquote><p><a href="https://mbed.org/platforms/ST-Nucleo-F411RE/" target="_blank" rel="noreferrer">https://mbed.org/platforms/ST-Nucleo-F411RE/</a><a href="https://mbed.org/handbook/Homepage" target="_blank" rel="noreferrer">https://mbed.org/handbook/Homepage</a></p></blockquote><p>Using the mbed loader:</p><ol><li>Connect the Nucleo-F411RE to the host PC using the USB connector.</li><li>A new file system will appear called NUCLEO; open it with Windows Explorer (assuming that you are using Windows).</li><li>Drag and drop nuttx.bin into the MBED window. This will load the nuttx.bin binary into the Nucleo-F411RE. The NUCLEO window will close then re-open and the Nucleo-F411RE will be running the new code.</li></ol><h2 id="hardware" tabindex="-1">Hardware <a class="header-anchor" href="#hardware" aria-label="Permalink to &quot;Hardware&quot;">​</a></h2><h3 id="gpio" tabindex="-1">GPIO <a class="header-anchor" href="#gpio" aria-label="Permalink to &quot;GPIO&quot;">​</a></h3><pre><code>SERIAL_TX=PA_2    USER_BUTTON=PC_13
...
</code></pre><p>TTL to RS-232 converter connection:</p><pre><code>Nucleo CN9  STM32F411RE
----------- ------------
