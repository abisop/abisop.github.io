import{_ as n,c as t,al as i,o}from"./chunks/framework.NFAqBSgQ.js";const c=JSON.parse('{"title":"boards/mips/pic32mx/ubw32 README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/mips/pic32mx/boards/ubw32/README.md","filePath":"en/platforms/mips/pic32mx/boards/ubw32/README.md"}'),a={name:"en/platforms/mips/pic32mx/boards/ubw32/README.md"};function r(s,e,l,C,p,h){return o(),t("div",null,e[0]||(e[0]=[i(`<h1 id="boards-mips-pic32mx-ubw32-readme" tabindex="-1">boards/mips/pic32mx/ubw32 README <a class="header-anchor" href="#boards-mips-pic32mx-ubw32-readme" aria-label="Permalink to &quot;boards/mips/pic32mx/ubw32 README&quot;">​</a></h1><p>This README file discusses the port of NuttX to the Sparkfun UBW32 board. This port uses the original v2.5 board which is based on the MicroChip PIC32MX460F512L. See <a href="http://www.sparkfun.com/products/8971" target="_blank" rel="noreferrer">http://www.sparkfun.com/products/8971</a>. This older version has been replaced with this board <a href="http://www.sparkfun.com/products/9713" target="_blank" rel="noreferrer">http://www.sparkfun.com/products/9713</a>. See also <a href="http://www.schmalzhaus.com/UBW32/" target="_blank" rel="noreferrer">http://www.schmalzhaus.com/UBW32/</a>.</p><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><p>PIC32MX460F512L Pin Out MAX3232 Connection Toolchains Loading NuttX with PICkit2 LEDs Buttons PIC32MX Configuration Options Configurations</p><h1 id="pic32mx460f512l-pin-out" tabindex="-1">PIC32MX460F512L Pin Out <a class="header-anchor" href="#pic32mx460f512l-pin-out" aria-label="Permalink to &quot;PIC32MX460F512L Pin Out&quot;">​</a></h1><p>PIC32MX460F512L 100-Pin TQFP (USB) Pin Out. The mapping to the pins on the PCL Logic board are very simple, each pin is brought out to a connector label with the PIC32MX460F512L pin number.</p><p>On board logic only manages power, crystal, and USB signals.</p><p>LEFT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left)</p><hr><p>PIN NAME Board Connection (omitting pins brought to J3 and J4)</p><pre><code>1  RG15
2  Vdd
3  PMD5/RE5
...
8  T4CK/RC3
9  T5CK/SDI1/RC4
</code></pre><p>10 SCK2/PMA5/CN8/RG6 11 SDI2/PMA4/CN9/RG7 12 SDO2/PMA3/CN10/RG8 13 MCLR 14 SS2/PMA2/CN11/RG9 15 Vss 16 Vdd 17 TMS/RA0 18 INT1/RE8 19 INT2/RE9 20 AN5/C1IN+/VBUSON/CN7/RB5 21 AN4/C1IN-/CN6/RB4 22 AN3/C2IN+/CN5/RB3 23 AN2/C2IN-/CN4/RB2 RB1 ICSP/Debug/IO (J5) pin 6 (labeled B2) 24 PGEC1/AN1/CN3/RB1 RB1 ICSP/Debug/IO (J5) pin 7 (labeled B1) 25 PGED1/AN0/CN2/RB0 RB0 ICSP/Debug/IO (J5) pin 8 (labeled B0)</p><p>BOTTO M SIDE, LEFT-TO-RIGHT (if pin 1 is in upper left)</p><hr><p>PIN NAME Board Connection (omitting pins brought to J3 and J4)</p><p>26 PGEC2/AN6/OCFA/RB6 PGC ICSP/Debug/IO (J5) pin 5 (labeled PGC) 27 PGED2/AN7/RB7 PGD ICSP/Debug/IO (J5) pin 4 (labeled PGD) 28 VREF-/CVREF-/PMA7/RA9 29 VREF+/CVREF+/PMA6/RA10 30 AVdd 31 AVss 32 AN8/C1OUT/RB8 33 AN9/C2OUT/RB9 34 AN10/CVREFOUT/PMA13/RB10 35 AN11/PMA12/RB11 36 Vss 37 Vdd 38 TCK/RA1 39 U2RTS/RF13 40 U2CTS/RF12 41 AN12/PMA11/RB12 42 AN13/PMA10/RB13 43 AN14/PMALH/PMA1/RB14 44 AN15/OCFB/PMALL/PMA0/CN12/RB15 45 Vss 46 Vdd 47 U1CTS/CN20/RD14 48 U1RTS/CN21/RD15 49 U2RX/PMA9/CN17/RF4 50 U2TX/PMA8/CN18/RF5</p><p>RIGHT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left)</p><hr><p>PIN NAME Board Connection (omitting pins brought to J3 and J4)</p><p>75 Vss 74 SOSCO/T1CK/CN0/RC14 73 SOSCI/CN1/RC13 72 SDO1/OC1/INT0/RD0 71 IC4/PMCS1/PMA14/RD11 70 SCK1/IC3/PMCS2/PMA15/RD10 69 SS1/IC2/RD9 68 RTCC/IC1/RD8 67 SDA1/INT4/RA15 66 SCL1/INT3/RA14 65 Vss 64 OSC2/CLKO/RC15 63 OSC1/CLKI/RC12 62 Vdd 61 TDO/RA5 60 TDI/RA4 59 SDA2/RA3 58 SCL2/RA2 57 D+/RG2 D+ Alternate USB (J6) pin 3 (labeled D+) USB host (JP1) pin USB Function (Mini B) 56 D-/RG3 D- Alternate USB (J6) pin 2 (labeled D-) USB host (JP1) pin USB Function (Mini B) 55 VUSB 54 VBUS VBUS Alternate USB (J6) pin 1 (labeled VBUS) USB host (JP1) pin USB Function (Mini B) Jumper JP1 for USB host functionality 53 U1TX/RF8 52 U1RX/RF2 51 USBID/RF3 USBID Alternate USB (J6) pin 4 (labeled ID) USB Function (Mini B) Also USB LED</p><p>TOP S IDE, LEFT-TO-RIGHT (if pin 1 i s in upper left)</p><hr><p>PIN NAME Board Connection (omitting pins brought to J3 and J4)</p><p>100 PMD4/RE4 99 PMD3/RE3 98 PMD2/RE2 RE2 LED1 97 TRD0/RG13 96 TRD1/RG12 95 TRD2/RG14 94 PMD1/RE1 RE1 LED2 93 PMD0/RE0 RE0 LED3 92 TRD3/RA7 91 TRCLK/RA6 90 PMD8/RG0 89 PMD9/RG1 88 PMD10/RF1 87 PMD11/RF0 86 ENVREG 85 Vcap/Vddcore 84 PMD15/CN16/RD7 83 PMD14/CN15/RD6 82 PMRD/CN14/RD5 81 OC5/PMWR/CN13/RD4 80 PMD13/CN19/RD13 79 IC5/PMD12/RD12 78 OC4/RD3 77 OC3/RD2 76 OC2/RD1</p><h1 id="max3232-connection" tabindex="-1">MAX3232 Connection <a class="header-anchor" href="#max3232-connection" aria-label="Permalink to &quot;MAX3232 Connection&quot;">​</a></h1><p>I use a tiny, MAX3232 board that I got from the eBay made by NKC Electronics (<a href="http://www.nkcelectronics.com/" target="_blank" rel="noreferrer">http://www.nkcelectronics.com/</a>). As of this writing, it is also available here: <a href="http://www.nkcelectronics.com/rs232-to-ttl-3v--55v-convert232356.html" target="_blank" rel="noreferrer">http://www.nkcelectronics.com/rs232-to-ttl-3v--55v-convert232356.html</a></p><p>CTS -- Not connected RTS -- Not connected TX -- J4 pin 31: U1TX/RF8 RX -- J4 pin 30: U1RX/RF2 GND -- J4 pin 40: GND Vcc -- J4 pin 39: 5V</p><h1 id="toolchains" tabindex="-1">Toolchains <a class="header-anchor" href="#toolchains" aria-label="Permalink to &quot;Toolchains&quot;">​</a></h1><p>MPLAB/C32 ---------</p><p>I am using the free, &quot;Lite&quot; version of the PIC32MX toolchain available for download from the microchip.com web site. I am using the Windows version. The MicroChip toolchain is the only toolchain currently supported in these configurations, but it should be a simple matter to adapt to other toolchains by modifying the Make.defs file include in each configuration.</p><p>C32 Toolchain Options:</p><pre><code>CONFIG_MIPS32_TOOLCHAIN_MICROCHIPW      - MicroChip full toolchain for Windows
...
</code></pre><h1 id="leds" tabindex="-1">LEDs <a class="header-anchor" href="#leds" aria-label="Permalink to &quot;LEDs&quot;">​</a></h1><hr><p>LABEL COLOR CONTROL</p><hr><p>USB Green RF3. This could be used by software if USB is not used. Otherwise, RF3 is used as the USBID signal. LED1 While RE2, Pulled up. Low value illuminates LED2 Red RE1, Pulled up. Low value illuminates LED3 Yellow RE0, Pulled up. Low value illuminates PWR Blue Illuminated when 5V is present, not controlled by software</p><p>If CONFIG_ARCH_LEDS is defined, then NuttX will control these LEDs as follows:</p><pre><code> ON                          OFF    
</code></pre><hr><pre><code> LED1   LED2   LED3   LED1   LED2   LED3
</code></pre><p>LED_STARTED 0 OFF OFF OFF --- --- --- LED_HEAPALLOCATE 1 ON OFF N/C --- --- --- LED_IRQSENABLED 2 OFF ON N/C --- --- --- LED_STACKCREATED 3 ON ON N/C --- --- --- LED_INIRQ 4 N/C N/C ON N/C N/C OFF LED_SIGNAL 4 N/C N/C ON N/C N/C OFF LED_ASSERTION 4 N/C N/C ON N/C N/C OFF LED_PANIC 5 ON N/C N/C OFF N/C N/C</p><h1 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h1><pre><code>RE6 User switch
RE7 Program switch
...
</code></pre>`,78)]))}const u=n(a,[["render",r]]);export{c as __pageData,u as default};
