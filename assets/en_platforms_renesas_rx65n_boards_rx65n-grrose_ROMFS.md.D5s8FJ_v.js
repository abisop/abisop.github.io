import{_ as r,c as t,al as s,o}from"./chunks/framework.NFAqBSgQ.js";const m=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/renesas/rx65n/boards/rx65n-grrose/ROMFS.md","filePath":"en/platforms/renesas/rx65n/boards/rx65n-grrose/ROMFS.md"}'),i={name:"en/platforms/renesas/rx65n/boards/rx65n-grrose/ROMFS.md"};function n(a,e,d,p,c,h){return o(),t("div",null,e[0]||(e[0]=[s(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><h2 id="overview" tabindex="-1">Overview <a class="header-anchor" href="#overview" aria-label="Permalink to &quot;Overview&quot;">​</a></h2><p>This directory contains logic to support a custom ROMFS system-init script and start-up script. These scripts are used by by the NSH when it starts provided that CONFIG_ETC_ROMFS=y. These scripts provide a ROMFS volume that will be mounted at /etc and will look like this at run-time:</p><pre><code>NuttShell (NSH) NuttX-8.2
nsh&gt; ls -Rl /etc
/etc:
 dr-xr-xr-x       0 .
 -r--r--r--      20 group
...
</code></pre>`,19)]))}const u=r(i,[["render",n]]);export{m as __pageData,u as default};
