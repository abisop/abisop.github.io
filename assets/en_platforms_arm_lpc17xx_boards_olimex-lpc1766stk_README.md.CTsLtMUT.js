import{_ as t,c as n,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const p=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/lpc17xx/boards/olimex-lpc1766stk/README.md","filePath":"en/platforms/arm/lpc17xx/boards/olimex-lpc1766stk/README.md"}'),s={name:"en/platforms/arm/lpc17xx/boards/olimex-lpc1766stk/README.md"};function a(r,e,l,h,d,u){return i(),n("div",null,e[0]||(e[0]=[o(`<p>README ^^^^^^</p><p>README for NuttX port to the Olimex LPC1766-STK development board</p><p>Contents ^^^^^^^^</p><p>Olimex LPC1766-STK development board LEDs Serial Console Using OpenOCD and GDB with an FT2232 JTAG emulator Olimex LPC1766-STK Configuration Options USB Host Configuration Configurations</p><p>Olimex LPC1766-STK development board ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</p><p>GPIO Usage: -----------</p><p>GPIO PIN SIGNAL NAME</p><hr><p>P0[0]/RD1/TXD3/SDA1 46 RD1 P0[1]/TD1/RXD3/SCL1 47 TD1 P0[2]/TXD0/AD0[7] 98 TXD0 P0[3]/RXD0/AD0[6] 99 RXD0 P0[4]/I2SRX_CLK/RD2/CAP2[0] 81 LED2/ACC IRQ P0[5]/I2SRX_WS/TD2/CAP2[1] 80 CENTER P0[6]/I2SRX_SDA/SSEL1/MAT2[0] 79 SSEL1 P0[7]/I2STX_CLK/SCK1/MAT2[1] 78 SCK1 P0[8]/I2STX_WS/MISO1/MAT2[2] 77 MISO1 P0[9]/I2STX_SDA/MOSI1/MAT2[3] 76 MOSI1 P0[10]/TXD2/SDA2/MAT3[0] 48 SDA2 P0[11]/RXD2/SCL2/MAT3[1] 49 SCL2 P0[15]/TXD1/SCK0/SCK 62 TXD1 P0[16]/RXD1/SSEL0/SSEL 63 RXD1 P0[17]/CTS1/MISO0/MISO 61 CTS1 P0[18]/DCD1/MOSI0/MOSI 60 DCD1 P0[19]/DSR1/SDA1 59 DSR1 P0[20]/DTR1/SCL1 58 DTR1 P0[21]/RI1/RD1 57 MMC PWR P0[22]/RTS1/TD1 56 RTS1 P0[23]/AD0[0]/I2SRX_CLK/CAP3[0] 9 BUT1 P0[24]/AD0[1]/I2SRX_WS/CAP3[1] 8 TEMP P0[25]/AD0[2]/I2SRX_SDA/TXD3 7 MIC IN P0[26]/AD0[3]/AOUT/RXD3 6 AOUT P0[27]/SDA0/USB_SDA 25 USB_SDA P0[28]/SCL0/USB_SCL 24 USB_SCL P0[29]/USB_D+ 29 USB_D+ P0[30]/USB_D- 30 USB_D- P1[0]/ENET_TXD0 95 E_TXD0 P1[1]/ENET_TXD1 94 E_TXD1 P1[4]/ENET_TX_EN 93 E_TX_EN P1[8]/ENET_CRS 92 E_CRS P1[9]/ENET_RXD0 91 E_RXD0 P1[10]/ENET_RXD1 90 E_RXD1 P1[14]/ENET_RX_ER 89 E_RX_ER P1[15]/ENET_REF_CLK 88 E_REF_CLK P1[16]/ENET_MDC 87 E_MDC P1[17]/ENET_MDIO 86 E_MDIO P1[18]/USB_UP_LED/PWM1[1]/CAP1[0] 32 USB_UP_LED P1[19]/MC0A/#USB_PPWR/CAP1[1] 33 #USB_PPWR P1[20]/MCFB0/PWM1[2]/SCK0 34 SCK0 P1[21]/MCABORT/PWM1[3]/SSEL0 35 SSEL0 P1[22]/MC0B/USB_PWRD/MAT1[0] 36 USBH_PWRD P1[23]/MCFB1/PWM1[4]/MISO0 37 MISO0 P1[24]/MCFB2/PWM1[5]/MOSI0 38 MOSI0 P1[25]/MC1A/MAT1[1] 39 LED1 P1[26]/MC1B/PWM1[6]/CAP0[0] 40 CS_UEXT P1[27]/CLKOUT/#USB_OVRCR/CAP0[1] 43 #USB_OVRCR P1[28]/MC2A/PCAP1[0]/MAT0[0] 44 P1.28 P1[29]/MC2B/PCAP1[1]/MAT0[1] 45 P1.29 P1[30]/VBUS/AD0[4] 21 VBUS P1[31]/SCK1/AD0[5] 20 AIN5 P2[0]/PWM1[1]/TXD1 75 UP P2[1]/PWM1[2]/RXD1 74 DOWN P2[2]/PWM1[3]/CTS1/TRACEDATA[3] 73 TRACE_D3 P2[3]/PWM1[4]/DCD1/TRACEDATA[2] 70 TRACE_D2 P2[4]/PWM1[5]/DSR1/TRACEDATA[1] 69 TRACE_D1 P2[5]/PWM1[6]/DTR1/TRACEDATA[0] 68 TRACE_D0 P2[6]/PCAP1[0]/RI1/TRACECLK 67 TRACE_CLK P2[7]/RD2/RTS1 66 LEFT P2[8]/TD2/TXD2 65 RIGHT P2[9]/USB_CONNECT/RXD2 64 USBD_CONNECT P2[10]/#EINT0/NMI 53 ISP_E4 P2[11]/#EINT1/I2STX_CLK 52 #EINT1 P2[12]/#EINT2/I2STX_WS 51 WAKE-UP P2[13]/#EINT3/I2STX_SDA 50 BUT2 P3[25]/MAT0[0]/PWM1[2] 27 LCD_RST P3[26]/STCLK/MAT0[1]/PWM1[3] 26 LCD_BL</p><p>Serial Console --------------</p><p>The LPC1766-STK board has two serial connectors. One, RS232_0, connects to the LPC1766 UART0. This is the DB-9 connector next to the power connector. The other RS232_1, connect to the LPC1766 UART1. This is he DB-9 connector next to the Ethernet connector.</p><p>Simple UART1 is the more flexible UART and since the needs for a serial console are minimal, the more minimal UART0/RS232_0 is used for the NuttX system console. Of course, this can be changed by editing the NuttX configuration file as discussed below.</p><p>The serial console is configured as follows (57600 8N1):</p><pre><code>BAUD: 57600
Number of Bits: 8
Parity: None
Stop bits: 1
</code></pre><p>You will need to connect a monitor program (Hyperterminal, Tera Term, minicom, whatever) to UART0/RS232_0 and configure the serial port as shown above.</p><p>NOTE: These configurations have problems at 115200 baud.</p><p>LCD ---</p><p>The LPC1766-STK has a Nokia 6100 132x132 LCD and either a Phillips PCF8833 or an Epson S1D15G10 LCD controller. The NuttX configuration may have to be adjusted depending on which controller is used with the LCD. The &quot;LPC1766-STK development board Users Manual&quot; states that the board features a &quot;LCD NOKIA 6610 128x128 x12bit color TFT with Epson LCD controller.&quot; But, referring to a different Olimex board, &quot;Nokia 6100 LCD Display Driver,&quot; Revision 1, James P. Lynch (&quot;Nokia 6100 LCD Display Driver.pdf&quot;) says:</p><p>&quot;The major irritant in using this display is identifying the graphics controller; there are two possibilities (Epson S1D15G00 or Philips PCF8833). The LCD display sold by the German Web Shop Jelu has a Leadis LDS176 controller but it is 100% compatible with the Philips PCF8833). So how do you tell which controller you have? Some message boards have suggested that the LCD display be disassembled and the controller chip measured with a digital caliper well that&#39;s getting a bit extreme.</p><p>&quot;Here&#39;s what I know. The Olimex boards have both display controllers possible; if the LCD has a GE-12 sticker on it, it&#39;s a Philips PCF8833. If it has a GE-8 sticker, it&#39;s an Epson controller. The older Sparkfun 6100 displays were Epson, their web site indicates that the newer ones are an Epson clone. Sparkfun software examples sometimes refer to the Philips controller so the whole issue has become a bit murky. The trading companies in Honk Kong have no idea what is inside the displays they are selling. A Nokia 6100 display that I purchased from Hong Kong a couple of weeks ago had the Philips controller.&quot;</p><p>The LCD connects to the LPC1766 via SPI and two GPIOs. The two GPIOs are noted above:</p><pre><code>P1.21 is the SPI chip select, and
P3.25 is the LCD reset
P3.26 is PWM1 output used to control the backlight intensity.
</code></pre><p>MISO0 and MOSI0 are join via a 1K ohm resistor so the LCD appears to be write only.</p><p>STATUS: The LCD driver was never properly integrated. It was awkward to use because it relied on a 9-bit SPI interface (the 9th bit being the command/data bit which is normally a discrete input). All support for the Nokia 6100 was removed on May 19, 2018. That obsoleted driver can be viewed in the nuttx/drivers/lcd and boards/arm/lpc17xx_40xx/olimex-lpc1766stk directories of the Obsoleted repository.</p><p>The obsoleted driver attempted to created the 9th bit on-they-flay in the data by expanding the 8-bit data to 16-bits with the 9th bit managed. I no longer believe that is the correct technical approach. I now believe that the best solution would be to provide custom management of the 9th data bit inside of the low-level MCU driver, the LPC17 SPI driver in thisi case, via a configuration option on the low-level driver.</p><p>LEDs ^^^^</p><p>If CONFIG_ARCH_LEDS is defined, then support for the LPC1766-STK LEDs will be included in the build. See:</p><ul><li><p>boards/arm/lpc17xx_40xx/olimex-lpc1766stk/include/board.h - Defines LED constants, types and prototypes the LED interface functions.</p></li><li><p>boards/arm/lpc17xx_40xx/olimex-lpc1766stk/src/lpc1766stk.h - GPIO settings for the LEDs.</p></li><li><p>boards/arm/lpc17xx_40xx/olimex-lpc1766stk/src/up_leds.c - LED control logic.</p></li></ul><p>The LPC1766-STK has two LEDs. If CONFIG_ARCH_LEDS is defined, these LEDs will be controlled as follows for NuttX debug functionality (where NC means &quot;No Change&quot;). Basically,</p><p>LED1: - OFF means that the OS is still initializing. Initialization is very fast so if you see this at all, it probably means that the system is hanging up somewhere in the initialization phases. - ON means that the OS completed initialization. - Glowing means that the LPC17 is running in a reduced power mode: LED1 is turned off when the processor enters sleep mode and back on when it wakesup up.</p><p>LED2: - ON/OFF toggles means that various events are happening. - GLowing: LED2 is turned on and off on every interrupt so even timer interrupts should cause LED2 to glow faintly in the normal case. - Flashing. If the LED2 is flashing at about 2Hz, that means that a crash has occurred. If CONFIG_ARCH_STACKDUMP=y, you will get some diagnostic information on the console to help debug what happened.</p><p>NOTE: LED2 is controlled by a jumper labeled: ACC_IRQ/LED2. That jump must be in the LED2 position in order to support LED2.</p><p>LED1 LED2 Meaning</p><hr><p>OFF OFF S till initializing and there is no interrupt activity. Initialization is very fast so if you see this, it probably means that the system is hung up somewhere in the initialization phases. OFF Glowing Still initializing (see above) but taking interrupts. OFF ON This would mean that (1) initialization did not complete but the software is hung, perhaps in an infinite loop, somewhere inside of an interrupt handler. OFF Flashing Ooops! We crashed before finishing initialization (or, perhaps after initialization, during an interrupt while the LPC17xx/LPC40xx was sleeping -- see below).</p><p>ON OFF The system has completed initialization, but is apparently not taking any interrupts. ON Glowing The OS successfully initialized and is taking interrupts (but, for some reason, is never entering a reduced power mode -- perhaps the CPU is very busy?). ON ON This would mean that (1) the OS complete initialization, but (2) the software is hung, perhaps in an infinite loop, somewhere inside of a signal or interrupt handler. Glowing Glowing This is also a normal healthy state: The OS successfully initialized, is running in reduced power mode, but taking interrupts. The glow is very faint and you may have to dim the lights to see that LEDs are active at all! See note below. ON Flashing Ooops! We crashed sometime after initialization.</p><p>NOTE: In glowing/glowing case, you get some good subjective information about the behavior of your system by looking at the level of the LED glow (or better, by connecting O-Scope and calculating the actual duty):</p><ol><li>The intensity of the glow is determined by the duty of LED on/off toggle -- as the ON period becomes larger with respect the OFF period, the LED will glow more brightly.</li><li>LED2 is turned ON when entering an interrupt and turned OFF when returning from the interrupt. A brighter LED2 means that the system is spending more time in interrupt handling.</li><li>LED1 is turned OFF just before the processor goes to sleep. The processor sleeps until awakened by an interrupt. LED1 is turned back ON after the processor is re-awakened -- actually after returning from the interrupt that cause the processor to re-awaken (LED1 will be off during the execution of that interrupt). So a brighter LED1 means that the processor is spending less time sleeping.</li></ol><p>When my LPC1766 sits IDLE -- doing absolutely nothing but processing timer interrupts -- I see the following:</p><ol><li>LED1 glows dimly due to the timer interrupts.</li><li>But LED2 is even more dim! The LED ON time excludes the time processing the interrupt that re-awakens the processing. So this tells me that the LPC1766 is spending more time processing timer interrupts than doing any other kind of processing. That, of course, makes sense if the system is truly idle and only processing timer interrupts.</li></ol><p>Serial Console ^^^^^^^^^^^^^^</p><p>By default, all of these configurations use UART0 for the NuttX serial console. UART0 corresponds to the DB-9 connector labelled &quot;RS232_0&quot;. This is a female connector and will require a normal male-to-female RS232 cable to connect to a PC.</p><p>An alternate is UART1 which connects to the other DB-9 connector labeled &quot;RS232_1&quot;. UART1 is not enabled by default unless specifically noted otherwise in the configuration description. A normal serial cable must be used with the port as well.</p><p>By default serial console is configured for 57600 baud, 8-bit, 1 stop bit, and no parity. Higher rates will probably require minor modification of the UART initialization logic to use the fractional dividers.</p><p>Using OpenOCD and GDB with an FT2232 JTAG emulator ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</p><p>Downloading OpenOCD</p><pre><code>You can get information about OpenOCD here: http://openocd.berlios.de/web/
...
</code></pre><p>Olimex LPC1766-STK Configuration Options ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</p><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
...
</code></pre><p>LPC17xx/LPC40xx USB Host Configuration CONFIG_LPC17_40_OHCIRAM_SIZE Total size of OHCI RAM (in AHB SRAM Bank 1) CONFIG_LP17_USBHOST_NEDS Number of endpoint descriptors CONFIG_LP17_USBHOST_NTDS Number of transfer descriptors CONFIG_LPC17_40_USBHOST_TDBUFFERS Number of transfer descriptor buffers CONFIG_LPC17_40_USBHOST_TDBUFSIZE Size of one transfer descriptor buffer CONFIG_LPC17_40_USBHOST_IOBUFSIZE Size of one end-user I/O buffer. This can be zero if the application can guarantee that all end-user I/O buffers reside in AHB SRAM.</p><p>USB Host Configuration ^^^^^^^^^^^^^^^^^^^^^^</p><p>The NuttShell (NSH) configuration can be modified in order to support USB host operations. To make these modifications, do the following:</p><ol><li><p>First configure to build the NSH configuration from the top-level NuttX directory:</p><p>./configure olimex-lpc1766stk/nsh</p></li><li><p>Modify the top-level .config file to enable USB host using:</p><p>make menuconfig</p><p>Make the following changes:</p><p>System Type -&gt; LPC17xx/LPC40xx Peripheral Support CONFIG_LPC17_40_USBHOST=y</p><p>Device Drivers-&gt; USB Host Driver Support CONFIG_USBHOST=y CONFIG_USBHOST_ISOC_DISABLE=y CONFIG_USBHOST_MSC=y</p><p>Library Routines CONFIG_SCHED_WORKQUEUE=y</p></li></ol><p>When this change is made, NSH should be extended to support USB flash devices. When a FLASH device is inserted, you should see a device appear in the /dev (pseudo) directory. The device name should be like /dev/sda, /dev/sdb, etc. The USB mass storage device, is present it can be mounted from the NSH command line like:</p><p>ls /dev mount -t vfat /dev/sda /mnt/flash</p><p>Files on the connect USB flash device should then be accessible under the mountpoint /mnt/flash.</p><p>Configurations ^^^^^^^^^^^^^^</p><h2 id="common-configuration-notes" tabindex="-1">Common Configuration Notes <a class="header-anchor" href="#common-configuration-notes" aria-label="Permalink to &quot;Common Configuration Notes&quot;">​</a></h2><ol><li><p>Each Olimex LPC1766-STK configuration is maintained in a sub-directory and can be selected as follow:</p><p>tools/configure.sh olimex-lpc1766stk:<code>&lt;subdir&gt;</code></p><p>Where <code>&lt;subdir&gt;</code> is one of the sub-directories identified in the following paragraphs.</p><p>Use configure.bat instead of configure.sh if you are building in a Windows native environment.</p></li><li><p>These configurations use the mconf-based configuration tool. To change a configuration using that tool, you should:</p><p>a. Build and install the kconfig-mconf tool. See nuttx/README.txt see additional README.txt files in the NuttX tools repository.</p><p>b. Execute &#39;make menuconfig&#39; in nuttx/ in order to start the reconfiguration process.</p></li></ol><h2 id="configuration-sub-directories" tabindex="-1">Configuration Sub-Directories <a class="header-anchor" href="#configuration-sub-directories" aria-label="Permalink to &quot;Configuration Sub-Directories&quot;">​</a></h2><p>ftpc: This is a simple FTP client shell used to exercise the capabilities of the FTPC library (apps/netutils/ftpc). This example is configured to that it will only work as a &quot;built-in&quot; program that can be run from NSH when CONFIG_NSH_BUILTIN_APPS is defined.</p><pre><code>From NSH, the startup command sequence is then:
...
2. You may also want to define the following in your configuration file.
   ...
   CONFIG_DEBUG_INFO=y
   CONFIG_DEBUG_FTPC=y
</code></pre><p>hidkbd: This configuration directory supports a variant of an NSH configuration. It is set up to perform the HID keyboard test at apps/examples/hidkbd.</p><pre><code>NOTES:
...
</code></pre><p>hidmouse: This configuration directory supports a variant of an NSH configuration. It is set up to perform the touchscreen test at apps/examples/touchscreen using a USB HIB mouse instead a touchscreen device.</p><pre><code>NOTES:
...
</code></pre><p>nettest: This configuration directory may be used to enable networking using the LPC17xx/LPC40xx&#39;s Ethernet controller. It uses apps/examples/nettest to exercise the TCP/IP network.</p><p>nsh: Configures the NuttShell (nsh) located at apps/examples/nsh. The Configuration enables both the serial and telnet NSH interfaces. Support for the board&#39;s SPI-based MicroSD card is included.</p><pre><code>NOTE:  If you start the program with no SD card inserted, there will be
...
</code></pre><p>slip-httpd: This configuration is identical to the thttpd configuration except that it uses the SLIP data link layer via a serial driver instead of the Ethernet data link layer. The Ethernet driver is disabled; SLIP IP packets are exchanged on UART1; UART0 is still the serial console.</p><pre><code>1. Configure and build the slip-httpd configuration.
...
</code></pre><p>thttpd-binfs: This builds the THTTPD web server example using the THTTPD and the apps/examples/thttpd application. This version uses the built-in binary format with the BINFS file system and the Union File System. Otherwise it is equivalent to thttpd-binfs.</p><pre><code>NOTES:
...
1. Uses the ARM EABI toolchain under Windows.  But that is
   ...
   CONFIG_ARM_TOOLCHAIN_GNU_EABI=y      : GNU EABI toolchain for Windows
</code></pre><p>STATUS: 2015-06-02. This configuration was added in an attempt to replace thttpd-nxflat (see below). I concurrently get out-of-memory errors during execution of CGI. The 32KiB SRAM may be insufficient for this configuration; this might be fixed with some careful tuning of stack usage.</p><pre><code>2015-06-06: Modified to use the Union File System.  Untested.
...
</code></pre><p>thttpd-nxflat: This builds the THTTPD web server example using the THTTPD and the apps/examples/thttpd application. This version uses the NXFLAT binary format with the ROMFS file system, otherwise it is equivalent to thttpd-binfs.</p><pre><code>NOTES:
...
</code></pre><p>STATUS: 2015-06-02. Do to issues introduced by recent versions of GCC, NXFLAT is not often usable.</p><pre><code>  See https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=139630111
</code></pre><p>usbserial: This configuration directory exercises the USB serial class driver at apps/examples/usbserial. See apps/examples/README.txt for more information.</p><p>usbmsc: This configuration directory exercises the USB mass storage class driver at apps/system/usbmsc. See apps/examples/README.txt for more information.</p><p>zmodem: This is an alternative NSH configuration that was used to test Zmodem file transfers. It is similar to the standard NSH configuration but has the following differences:</p><pre><code>1. UART0 is still the NuttX serial console as with most of the other
...
STATUS
  ...
  2013-7-16. More Testing against the NuttX rz/sz on Both Ends.
    ...
    family.
</code></pre>`,99)]))}const f=t(s,[["render",a]]);export{p as __pageData,f as default};
