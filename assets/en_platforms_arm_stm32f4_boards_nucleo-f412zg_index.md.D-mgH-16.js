import{_ as n,c as o,al as t,o as a}from"./chunks/framework.NFAqBSgQ.js";const h=JSON.parse('{"title":"ST Nucleo F412ZG","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/stm32f4/boards/nucleo-f412zg/index.md","filePath":"en/platforms/arm/stm32f4/boards/nucleo-f412zg/index.md"}'),i={name:"en/platforms/arm/stm32f4/boards/nucleo-f412zg/index.md"};function r(s,e,l,c,d,u){return a(),o("div",null,e[0]||(e[0]=[t(`<h1 id="st-nucleo-f412zg" tabindex="-1">ST Nucleo F412ZG <a class="header-anchor" href="#st-nucleo-f412zg" aria-label="Permalink to &quot;ST Nucleo F412ZG&quot;">​</a></h1><p>chip:stm32, chip:stm32f4, chip:stm32f412</p><p>This page discusses issues unique to NuttX configurations for the ST Nucleo F412ZG board from ST Micro. See</p><blockquote><p><a href="http://www.st.com/en/evaluation-tools/nucleo-f412zg.html" target="_blank" rel="noreferrer">http://www.st.com/en/evaluation-tools/nucleo-f412zg.html</a></p></blockquote><p>NucleoF412ZG:</p><ul><li>Microprocessor: 32-bit ARM Cortex M4 at 100MHz STM32F412ZG</li><li>Memory: 1 MB Flash and 256 KB SRAM</li><li>ADC: 1x12-bit, 2.4 MSPS A/D converter: up to 16 channels</li><li>DMA: 2x8-stream DMA controllers with FIFOs and burst support</li><li>Timers: Up to 17 timers: up to 12 16-bit, 2 32-bit timers, two watchdog timers, and a SysTick timer</li><li>GPIO: Up to 114 I/O ports with interrupt capability</li><li>I2C: Up to 4 I2C interfaces</li><li>USARTs: Up to 4 USARTs</li><li>SPIs: Up to 5 SPIs (5 I2S)</li><li>SDIO interface (SD/MMC/eMMC)</li><li>Advanced connectivity: USB 2.0 full-speed device/host/OTG controller with PHY</li><li>2x CAN (2.0B Active)</li><li>True random number generator</li><li>CRC calculation unit</li><li>96-bit unique ID</li><li>RTC</li></ul><p>See: <a href="https://www.st.com/content/ccc/resource/technical/document/user_manual/group0/26/49/90/2e/33/0d/4a/da/DM00244518/files/DM00244518.pdf/jcr:content/translations/en.DM00244518.pdf" target="_blank" rel="noreferrer">https://www.st.com/content/ccc/resource/technical/document/user_manual/group0/26/49/90/2e/33/0d/4a/da/DM00244518/files/DM00244518.pdf/jcr:content/translations/en.DM00244518.pdf</a></p><ul><li>Peripherals: 3 led, 2 push button</li><li>Debug: Serial wire debug and JTAG interfaces</li><li>Expansion I/F Ardino and Morpho Headers</li></ul><h2 id="hardware" tabindex="-1">Hardware <a class="header-anchor" href="#hardware" aria-label="Permalink to &quot;Hardware&quot;">​</a></h2><h3 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h3><p>B1 USER: the user button is connected to the I/O PC13 (pin 2) of the STM32 microcontroller.</p><h3 id="leds" tabindex="-1">LEDs <a class="header-anchor" href="#leds" aria-label="Permalink to &quot;LEDs&quot;">​</a></h3><p>The Nucleo F410RB provide a single user LED, LD2. LD2 is the green LED connected to Arduino signal D13 corresponding to MCU I/O PA5 (pin 21) or PB13 (pin 34) depending on the STM32target.</p><ul><li>When the I/O is HIGH value, the LED is on.</li><li>When the I/O is LOW, the LED is off.</li></ul><p>These LEDs are not used by the board port unless CONFIG_ARCH_LEDS is defined. In that case, the usage by the board port is defined in include/board.h and src/sam_leds.c. The LEDs are used to encode OS-related events as follows when the red LED (PE24) is available:</p><pre><code>SYMBOL                Meaning                   LD2
-------------------  -----------------------  -----------
...
pin selections.
</code></pre><p>TTL to RS-232 converter connection:</p><pre><code>Nucleo CN10 STM32F412ZG
----------- ------------
...
</code></pre><p>TTL to RS-232 converter connection:</p><pre><code>Nucleo CN9  STM32F412ZG
----------- ------------
