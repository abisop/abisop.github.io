import{_ as n,c as t,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const S=JSON.parse('{"title":"README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/samd2l2/boards/samd20-xplained/README.md","filePath":"en/platforms/arm/samd2l2/boards/samd20-xplained/README.md"}'),a={name:"en/platforms/arm/samd2l2/boards/samd20-xplained/README.md"};function s(r,e,l,u,d,h){return i(),t("div",null,e[0]||(e[0]=[o(`<h1 id="readme" tabindex="-1">README <a class="header-anchor" href="#readme" aria-label="Permalink to &quot;README&quot;">​</a></h1><p>This README discusses issues unique to NuttX configurations for the Atmel SAMD20 Xplained Pro development board. This board features the ATSAMD20J18A MCU.</p><p>The SAMD20 Xplained Pro Starter Kit may be bundled with three modules:</p><ol><li>I/O1 - An MMC/SD card slot, PWM LED control, ADC light sensor, USART loopback, TWI AT30TSE758 Temperature sensor.</li><li>OLED1 - An OLED plus 3 additional switches and 3 additional LEDs</li><li>PROTO1 - A prototyping board with logic on board (other than power-related logic).</li></ol><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><ul><li>STATUS/ISSUES</li><li>Modules</li><li>Development Environment</li><li>GNU Toolchain Options</li><li>IDEs</li><li>NuttX EABI &quot;buildroot&quot; Toolchain</li><li>LEDs</li><li>Serial Consoles</li><li>Atmel Studio 6.1</li><li>SAMD20 Xplained Pro-specific Configuration Options</li><li>Configurations</li></ul><h1 id="status-issues" tabindex="-1">STATUS/ISSUES <a class="header-anchor" href="#status-issues" aria-label="Permalink to &quot;STATUS/ISSUES&quot;">​</a></h1><pre><code>1. The FLASH wait states is set to 2 (see include/board.h).  According to
...
----  ---- ---- ---- ------------------
 ...
 19   GND  GND  GND  N/A
 20   VCC  VCC  VCC  N/A
</code></pre><p>There are options available in the NuttX configuration to select which connector SERCOM4 is on: SAMD20_XPLAINED_USART4_EXTn, where n=1, 2, or 3.</p><p>If you have a TTL to RS-232 converter then this is the most convenient serial console to use (because you don&#39;t lose the console device each time you lose the USB connection). It is the default in all of these configurations. An option is to use the virtual COM port.</p><p>Virtual COM Port ----------------</p><p>The SAMD20 Xplained Pro contains an Embedded Debugger (EDBG) that can be used to program and debug the ATSAMD20J18A using Serial Wire Debug (SWD). The Embedded debugger also include a Virtual COM port interface over SERCOM3. Virtual COM port connections:</p><pre><code>PA24 SERCOM3 / USART TXD
PA25 SERCOM3 / USART RXD
</code></pre><h1 id="atmel-studio-6-1" tabindex="-1">Atmel Studio 6.1 <a class="header-anchor" href="#atmel-studio-6-1" aria-label="Permalink to &quot;Atmel Studio 6.1&quot;">​</a></h1><p>Loading Code into FLASH: -----------------------</p><p>Tools menus: Tools -&gt; Device Programming.</p><p>Debugging the NuttX Object File -------------------------------</p><ol><li><p>Rename object file from nutt to nuttx.elf. That is an extension that will be recognized by the file menu.</p></li><li><p>File menu: File -&gt; Open -&gt; Open object file for debugging</p><ul><li>Select nuttx.elf object file</li><li>Select AT91SAMD20J18</li><li>Select files for symbols as desired</li><li>Select debugger</li></ul></li><li><p>Debug menu: Debug -&gt; Start debugging and break</p><ul><li>This will reload the nuttx.elf file into FLASH</li></ul></li></ol><h1 id="samd20-xplained-pro-specific-configuration-options" tabindex="-1">SAMD20 Xplained Pro-specific Configuration Options <a class="header-anchor" href="#samd20-xplained-pro-specific-configuration-options" aria-label="Permalink to &quot;SAMD20 Xplained Pro-specific Configuration Options&quot;">​</a></h1><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
...
</code></pre><p>Individual subsystems can be enabled:</p><pre><code>CONFIG_SAMD2L2_WDT     - Watchdog Timer&quot;
...
</code></pre><p>SAMD20 specific device driver settings</p><pre><code>CONFIG_USARTn_SERIAL_CONSOLE - selects the USARTn (n=0,1,2,..5) for the
...
</code></pre><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each SAMD20 Xplained Pro configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh samd20-xplained:&lt;subdir&gt;
...
5. If the OLED1 module is connected to the SAMD20 Xplained Pro, then
   ...
   ** The hardware is write only, but the driver maintains a frame buffer
   ...
   welcome.
</code></pre>`,85)]))}const C=n(a,[["render",s]]);export{S as __pageData,C as default};
