import{_ as n,c as t,al as i,o}from"./chunks/framework.NFAqBSgQ.js";const l=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/lpc17xx/boards/mcb1700/README.md","filePath":"en/platforms/arm/lpc17xx/boards/mcb1700/README.md"}'),s={name:"en/platforms/arm/lpc17xx/boards/mcb1700/README.md"};function _(r,e,a,C,d,c){return o(),t("div",null,e[0]||(e[0]=[i(`<p>README ^^^^^^</p><p>README for NuttX port to the Keil mcb1700 LPC1768 board.</p><p>Contents ^^^^^^^^</p><p>USB Device Controller Functions mcb1700 Configuration Options USB Host Configuration Configurations</p><p>mcb1700 Configuration Options ^^^^^^^^^^^^^^^^^^^^^^^^^^</p><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
