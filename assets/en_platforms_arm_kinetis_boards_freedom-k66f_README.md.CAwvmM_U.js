import{_ as t,c as n,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const h=JSON.parse('{"title":"README.txt","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/kinetis/boards/freedom-k66f/README.md","filePath":"en/platforms/arm/kinetis/boards/freedom-k66f/README.md"}'),r={name:"en/platforms/arm/kinetis/boards/freedom-k66f/README.md"};function a(s,e,d,l,p,I){return i(),n("div",null,e[0]||(e[0]=[o(`<h1 id="readme-txt" tabindex="-1">README.txt <a class="header-anchor" href="#readme-txt" aria-label="Permalink to &quot;README.txt&quot;">​</a></h1><p>This is the README file for the port of NuttX to the Freescale Freedom-K66F development board.</p><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><p>o Freedom K66F Features o Serial Console o LEDs and Buttons o Networking Support o SD Card Support o USB Device Controller Support o Development Environment o GNU Toolchain Options o Freedom K66F Configuration Options o Configurations o Status</p><h1 id="kinetis-freedom-k66f-features" tabindex="-1">Kinetis Freedom K66F Features: <a class="header-anchor" href="#kinetis-freedom-k66f-features" aria-label="Permalink to &quot;Kinetis Freedom K66F Features:&quot;">​</a></h1><p>The features of the FRDM-K66F hardware are as follows:</p><ul><li>MK66FN2M0VMD18 MCU (180 MHz, 2MB Flash, 256KB RAM, 144MBGA package)</li><li>Dual role USB interface with micro-B USB connector</li><li>RGB LED</li><li>FXOS8700CQ - accelerometer and magnetometer</li><li>FXAS21002 - Gyroscope</li><li>Two user push buttons</li><li>Flexible power supply options -- OpenSDAv2.1 USB, K66F USB, and external sources</li><li>Easy access to MCU input/output through Arduino R3TM compatible I/O connectors</li><li>Programmable OpenSDAv2.1 debug interface with multiple applications available including: o SWD debug interface over a USB HID connection providing run-control debugging and compatibility with IDE tools o Virtual serial port interface</li><li>Ethernet</li><li>Micro SD</li><li>Audio features o Digital MEMS microphone o Auxiliary input jack o Headset/Analog microphone jack o Two optional input for analogue microphone</li><li>Optional header for add-on RF module: RF24L01+ Nordic 2.4 GHz Radio</li><li>Optional header for add-on Bluetooth module: JY-MCU BT Board V1.05 BT</li></ul><h1 id="opensdav2-1" tabindex="-1">OpenSDAv2.1 <a class="header-anchor" href="#opensdav2-1" aria-label="Permalink to &quot;OpenSDAv2.1&quot;">​</a></h1><p>The FRDM-K66F platform features OpenSDAv2.1, the NXP open-source hardware embedded serial and debug adapter running an open-source bootloader. This circuit offers several options for serial communication, flash programming and run-control debugging. The openSDAv2.1 is loaded with JLink firmware for rapid prototyping and product development, with a focus on connected Internet of Things devices.</p><p>To use set raw binary output for nuttx.bin</p><h1 id="serial-console" tabindex="-1">Serial Console <a class="header-anchor" href="#serial-console" aria-label="Permalink to &quot;Serial Console&quot;">​</a></h1><h2 id="usb-vcom-console" tabindex="-1">USB VCOM Console <a class="header-anchor" href="#usb-vcom-console" aria-label="Permalink to &quot;USB VCOM Console&quot;">​</a></h2><p>The primary serial port interface signals are PTB16 UART0_RX and PTB17 UART0_TX. These signals are connected to the OpenSDAv2.1 VCOM circuit.</p><h2 id="serial-shield-console" tabindex="-1">Serial Shield Console <a class="header-anchor" href="#serial-shield-console" aria-label="Permalink to &quot;Serial Shield Console&quot;">​</a></h2><p>An alternative serial port might use a standard serial shield mounted on the Freedom Board. In this case, Arduino pin D1 provides UART TX and pin D0 provides UART RX.</p><p>The I/O headers on the FRDM-K66F board are arranged to enable compatibility with Arduino shield. The outer rows of pins (even numbered pins) on the headers, share the same mechanical spacing and placement with the I/O headers on the Arduino Revision 3 (R3) standard.</p><p>The Arduino D0 and D1 pins then correspond to pins 2 and 4 on the J1 I/O connector:</p><pre><code>Arduino Pin              FRDM-K66F J1 Connector
------------------------ -----------------------
UART RX, Arduino D0 pin  Pin 2, PTC3, UART1_RX
UART TX, Arduino D1 pin  Pin 4, PTC4, UART1_TX
</code></pre><h2 id="default-serial-console" tabindex="-1">Default Serial Console <a class="header-anchor" href="#default-serial-console" aria-label="Permalink to &quot;Default Serial Console&quot;">​</a></h2><p>By default, these configuration are setup to use the Serial Console on UART1. That, however, is easily reconfigured.</p><h1 id="leds-and-buttons" tabindex="-1">LEDs and Buttons <a class="header-anchor" href="#leds-and-buttons" aria-label="Permalink to &quot;LEDs and Buttons&quot;">​</a></h1><h2 id="rgb-led" tabindex="-1">RGB LED <a class="header-anchor" href="#rgb-led" aria-label="Permalink to &quot;RGB LED&quot;">​</a></h2><p>An RGB LED is connected through GPIO as shown below:</p><pre><code>LED    K66
------ -------------------------------------------------------
...
</code></pre><p>If CONFIG_ARCH_LEDs is defined, then NuttX will control the LED on board the Freedom K66. Usage of these LEDs is defined in include/board.h and src/K66_leds.c. The following definitions describe how NuttX controls the LEDs:</p><pre><code>SYMBOL                Meaning                 LED state
                                              RED   GREEN  BLUE
-------------------  -----------------------  -----------------
...
</code></pre><h2 id="buttons" tabindex="-1">Buttons <a class="header-anchor" href="#buttons" aria-label="Permalink to &quot;Buttons&quot;">​</a></h2><p>Two push button switches, SW2 and SW3, are available on the FRDM-K66F board. SW2 is connected to PTD11 and SW3 is connected to PTA10. Beside the general purpose IO function, both SW2 and SW3 can be used as a low-leakage wakeup (LLWU) source.</p><pre><code>Switch    GPIO Function
--------- ---------------------------------------------------------------
...
</code></pre><p>NOTE: In this configuration is is normal to have packet loss &gt; 0% the first time you ping due to the default handling of the ARP table.</p><p>On the host side, you should also be able to ping the FRDM-K66F:</p><pre><code>$ ping 10.0.0.2
...
------------ ------------- --------
</code></pre><p>There is no Write Protect pin available to the K66F.</p><h2 id="configuration-settings" tabindex="-1">Configuration Settings <a class="header-anchor" href="#configuration-settings" aria-label="Permalink to &quot;Configuration Settings&quot;">​</a></h2><p>Enabling SDHC support. The Freedom K66F provides one microSD memory card slot. Support for the SD slots can be enabled with the following settings:</p><pre><code>System Type-&gt;Kinetic Peripheral Selection
...
</code></pre><h1 id="freedom-k66f-configuration-options" tabindex="-1">Freedom K66F Configuration Options <a class="header-anchor" href="#freedom-k66f-configuration-options" aria-label="Permalink to &quot;Freedom K66F Configuration Options&quot;">​</a></h1><pre><code>CONFIG_ARCH - Identifies the arch/ subdirectory.  This should
   be set to:
...
</code></pre><p>Kinetis K66 specific device driver settings</p><pre><code>CONFIG_UARTn_SERIAL_CONSOLE - selects the UARTn (n=0..5) for the
...
</code></pre><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each Freedom K66F configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh freedom-K66F:&lt;subdir&gt;
...
</code></pre><h2 id="nsh" tabindex="-1">nsh: <a class="header-anchor" href="#nsh" aria-label="Permalink to &quot;nsh:&quot;">​</a></h2><p>Configures the NuttShell (nsh) located at apps/examples/nsh using a serial console on UART1.</p><pre><code>NOTES:
...
5. An SDHC driver is enabled in this configuration but does not yet work.
   ...
   TODO:Verify Claim
</code></pre><h1 id="status" tabindex="-1">Status <a class="header-anchor" href="#status" aria-label="Permalink to &quot;Status&quot;">​</a></h1><p>2016-07-12: Added support for the KSZ8081 PHY and added the netnsh configuration. The network is basically functional. More testing is needed, but I have not seen any obvious network failures.</p><pre><code>In testing, I notice a strange thing.  If I run at full optimization the
...
</code></pre><p>2017-02-14: nsh: SDHC DMA is not working yet. Buttons and SDIO with automounter is working. netnsh:Is building but Ethernet is not working yet. TX is called but not IRQ is issued.</p>`,129)]))}const c=t(r,[["render",a]]);export{h as __pageData,c as default};
