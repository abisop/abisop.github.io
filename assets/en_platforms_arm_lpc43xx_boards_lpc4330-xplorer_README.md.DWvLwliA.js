...
-wire=&lt;probe&gt; specifies the debug probe.  For LPCLink on Windows 7 use
    ...
    the full version.
</code></pre><p>Thus the correct invocation for the LPC4330 under Windows7 would be:</p><pre><code>target extended-remote | crt_emu_lpc18_43_nxp -2 -pLPC4330 -wire=winusb
...
</code></pre><p>Command Line Flash Programming ------------------------------</p><p>The LPC18xx/LPC43xx debug driver can also be used to program the LPC43xx flash directly from the command line. The script flash.sh that may be found in the boards/arm/lpc43xx/lpc4330-xplorer/scripts directory can do that with a single command line command.</p><p>Executing from SPIFI --------------------</p><p>By default, the configurations here assume that you are executing directly from SRAM.</p><pre><code>CONFIG_LPC43_BOOT_SRAM=y            : Executing in SRAM
...
</code></pre><h1 id="configurations" tabindex="-1">Configurations <a class="header-anchor" href="#configurations" aria-label="Permalink to &quot;Configurations&quot;">​</a></h1><p>Each LPC4330-Xplorer configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.sh lpc4330-xplorer:&lt;subdir&gt;
...
</code></pre>`,99)]))}const C=n(r,[["render",a]]);export{u as __pageData,C as default};
