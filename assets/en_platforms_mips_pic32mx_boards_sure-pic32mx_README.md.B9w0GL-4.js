import{_ as n,c as t,al as o,o as i}from"./chunks/framework.NFAqBSgQ.js";const d=JSON.parse('{"title":"boards/mips/pic32mx/sure-pic32mx README","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/mips/pic32mx/boards/sure-pic32mx/README.md","filePath":"en/platforms/mips/pic32mx/boards/sure-pic32mx/README.md"}'),a={name:"en/platforms/mips/pic32mx/boards/sure-pic32mx/README.md"};function r(s,e,C,l,u,p){return i(),t("div",null,e[0]||(e[0]=[o(`<h1 id="boards-mips-pic32mx-sure-pic32mx-readme" tabindex="-1">boards/mips/pic32mx/sure-pic32mx README <a class="header-anchor" href="#boards-mips-pic32mx-sure-pic32mx-readme" aria-label="Permalink to &quot;boards/mips/pic32mx/sure-pic32mx README&quot;">​</a></h1><p>This README file discusses the port of NuttX to the &quot;Advanced USB Storage Demo Board,&quot; Model DB-DP11215, from Sure Electronics (<a href="http://www.sureelectronics.net/" target="_blank" rel="noreferrer">http://www.sureelectronics.net/</a>). This board features the MicroChip PIC32MX440F512H. See also <a href="http://www.sureelectronics.net/goods.php?id=1168" target="_blank" rel="noreferrer">http://www.sureelectronics.net/goods.php?id=1168</a> for further information about the Sure DB-DP11215 board.</p><p>DB_DP11215 PIC32 Storage Demo Board</p><ul><li>PIC32MX44F512H</li><li>SD card slot</li><li>RS-2323 Interface</li><li>USB (MINI-B)</li><li>2x16 LCD display</li><li>Three tactile switches</li><li>Four user LEDs</li></ul><p>Also available (but not yet supported).</p><p>DB-DP11212 PIC32 General Purpose Demo Board</p><ul><li>PIC32MX44F512H</li><li>LM75A temperature sensor and temperature resistor (NTC-SMD thermistor)</li><li>SPI FLASH: AT25DF041A</li><li>USB (MINI-B)</li><li>2x16 LCD display</li><li>4 digit, 8 segment LED display</li><li>Three tactile switches</li><li>Four user LEDs</li></ul><p>NOTE: I see that Sure Electronics shows both of these boards at end-of-Life (EOL). So I assume that these boards will no longer be generally available. This work should still be useful, however, for other PIC32MX4-based boards (2012-5-27).</p><h1 id="contents" tabindex="-1">Contents <a class="header-anchor" href="#contents" aria-label="Permalink to &quot;Contents&quot;">​</a></h1><p>PIC32MX440F512H Pin Out Toolchains Loading NuttX with PICkit2 LCD1602 PIC32MX Configuration Options Configurations</p><h1 id="pic32mx440f512h-pin-out" tabindex="-1">PIC32MX440F512H Pin Out <a class="header-anchor" href="#pic32mx440f512h-pin-out" aria-label="Permalink to &quot;PIC32MX440F512H Pin Out&quot;">​</a></h1><h2 id="db-dp11215-pic32-storage-demo-board" tabindex="-1">DB_DP11215 PIC32 Storage Demo Board <a class="header-anchor" href="#db-dp11215-pic32-storage-demo-board" aria-label="Permalink to &quot;DB\\_DP11215 PIC32 Storage Demo Board&quot;">​</a></h2><p>PIC32MX440F512H 64-Pin QFN (USB) Pin Out as used on the DB_DP11215 PIC32 Storage Demo Board.</p><p>LEFT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 1 PMD5/RE5 PMPD5 Display, JP1-12, DB4 2 PMD6/RE6 PMPD6 Display, JP1-13, DB6 3 PMD7/RE7 PMPD7 Display, JP1-14, DB7 4 SCK2/PMA5/CN8/RG6 SCK SD connector SCK, FLASH (U1) SCK* 5 SDI2/PMA4/CN9/RG7 SDI SD connector DO, FLASH (U1) SO* 6 SDO2/PMA3/CN10/RG8 SDO SD connector DI, FLASH (U1) SI* 7 MCLR  PIC_MCLR Pulled high, J7-1, ICSP 8 SS2/PMA2/CN11/RG9 UTIL_CS FLASH (U1) CS* 9 Vss Grounded 10 Vdd +3.3V --- 11 AN5/C1IN+/Vbuson/CN7/RB5 Vbuson/AN5/RB5 To USB VBUS circuitry 12 AN4/C1IN-/CN6/RB4 SW_OK SW3, Pull high, low means SW3 closed 13 AN3/C2IN+/CN5/RB3 SW_UP SW1, Pull high, low means SW1 closed 14 AN2/C2IN-/CN4/RB2 SW_Down SW2, Pull high, low means SW2 closed 15 PGEC1/AN1/Vref-/CVref-/CN3/ ADC_SENSE_SWITCHED_+VBUS To USB VBUS circuitry RB1 16 PGED1/AN0/VREF+/CVREF+/PMA6/ N/C Not connected CN2/RB0</p><p>*FLASH (U1, SOIC) not populated</p><p>BOTTOM SIDE, LEFT-TO-RIGHT (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 17 PGEC2/AN6/OCFA/RB6 PIC_PGC2 J7-5, ICSP 18 PGED2/AN7/RB7 PIC_PGD2 J7-4, ICSP 19 AVdd +3.3V --- 20 AVss Grounded 21 AN8/U2CTS/C1OUT/RB8 N/C Not connected 22 AN9/C2OUT/PMA7/RB9 N/C Not connected 23 TMS/AN10/CVREFOUT/PMA13/RB10 UTIL_WP FLASH (U1) WP* 24 TDO/AN11/PMA12/RB11 SD_CS SD connector CS 25 Vss Grounded 26 Vdd +3.3V --- 27 TCK/AN12/PMA11/RB12 SD_CD SD connector CD 28 TDI/AN13/PMA10/RB13 SD_WD SD connector WD 29 AN14/U2RTS/PMALH/PMA1/RB14 N/C Not connected 30 AN15/OCFB/PMALL/PMA0/CN12/ PMPA0 Display, JP1-4, RS RB15 31 SDA2/U2RX/PMA9/CN17/RF4 RXD2_MCU J5 DB9 via RS232 driver 32 SCL2/U2TX/PMA8/CN18/RF5 TXD2_MCU J5 DB9 via RS232 driver</p><p>*FLASH (U1, SOIC) not populated</p><p>RIGHT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 48 SOSCO/T1CK/CN0/RC14 SOSCO 32.768KHz XTAL (Y1) 47 SOSCI/CN1/RC13 SOSCI 32.768KHz XTAL (Y1) 46 OC1/INT0/RD0 PWM1 Used to control backlight level (K) 45 IC4/PMCS1/PMA14/INT4/RD11 PMPCS1 Display, JP1-6, E 44 SCL1/IC3/PMCS2/PMA15/INT3/ USB_OPT USB PHY RD10 43 U1CTS/SDA1/IC2/INT2/RD9 USB_OPTEN USB PHY 42 RTCC/IC1/INT1/RD8 N/C Not connected 41 Vss Grounded 40 OSC2/CLKO/RC15 OSC2 20MHz XTAL (Y2) 39 OSC1/CLKI/RC12 OSC1 20MHz XTAL (Y2) 38 Vdd +3.3V --- 37 D+/RG2 APPS_D+ USB connectors via PHY 36 D-/RG3 APPS_D- USB connectors via PHY 35 Vusb +3.3V --- 34 Vbus VBUS_DEVICE_MODE Display, USB Mini-B, USB Type A, JP1-1, +5V 33 USBID/RF3 N/C Not connected</p><p>TOP SIDE, LEFT-TO-RIGHT (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 64 PMPD4/RE4 PMPD4 Display, JP1-11, DB4 63 PMPD3/RE3 PMPD3 Display, JP1-10, DB3 62 PMPD2/RE2 PMPD2 Display, JP1-9, DB2 61 PMPD1/RE1 PMPD1 Display, JP1-8, DB1 60 PMPD0/RE0 PMPD0 Display, JP1-7, DB0 59 RF1 RF1 Low illuminates LED/R/ERR 58 RF0 RF0 Low illuminates LED/Y/flash 57 ENVREG ENVREG Pulled high 56 Vcap/Vddcore VDDCORE Capactors to ground 55 CN16/RD7 RD7 Low illuminates LED/Y/USB 54 CN15/RD6 RD6 Low illuminates LED/Y/SD 53 PMRD/CN14/RD5 PMPRD Display, JP1-5, R/W 52 OC5/IC5/PMWR/CN13/RD4 N/C Not connected 51 U1TX/OC4/RD3 CP2102_RXD J6-3, UART1 (also CP2102*) 50 U1RX/OC3/RD2 CP2102_TXD J6-2, UART1 (also CP2102*) 49 U1RTS/OC2/RD1 PWM2 Used to control backlight level (Vo)</p><p>*USB-to-UART bridge (U1, CP2102) not populated</p><h2 id="db-dp11212-pic32-general-purpose-demo-board" tabindex="-1">DB-DP11212 PIC32 General Purpose Demo Board <a class="header-anchor" href="#db-dp11212-pic32-general-purpose-demo-board" aria-label="Permalink to &quot;DB-DP11212 PIC32 General Purpose Demo Board&quot;">​</a></h2><p>PIC32MX440F512H 64-Pin QFN (USB) Pin Out as used on the DB-DP11212 PIC32 General Purpose Demo Board</p><p>LEFT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 1 PMD5/RE5 PMPD5 Display, JP1-12, DB5 2 PMD6/RE6 PMPD6 Display, JP1-13, DB6 3 PMD7/RE7 PMPD7 Display, JP1-14, DB7 4 SCK2/PMA5/CN8/RG6 SCK FLASH (U4) SCK* 5 SDI2/PMA4/CN9/RG7 SDI FLASH (U4) SO* 6 SDO2/PMA3/CN10/RG8 SDO FLASH (U4) SI* 7 MCLR  PIC_MCLR Pulled high, J2-1, ICSP 8 SS2/PMA2/CN11/RG9 N/C Not connected 9 Vss Grounded 10 Vdd +3.3V --- 11 Vbuson/AN5/CN7/RB5 RB5 LCD SEG5 (F), U5-10 12 AN4/CN6/RB4 RB4 LCD SEG4 (E), U5-1 13 AN3/CN5/RB3 RB3 LCD SEG3 (D), U5-2 14 AN2/CN4/RB2 RB2 LCD SEG2 (C), U5-4 15 PGEC1/AN1/Vref-/CN3/RB1 RB1 LCD SEG1 (B), U5-7 16 PGED1/AN0/VREF+/CVREF+/PMA6/ RB0 LCD SEG0 (A), U5-11 CN2/RB0</p><p>*FLASH (U4, SOIC) not populated</p><p>BOTTOM SIDE, LEFT-TO-RIGHT (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 17 PGEC2/AN6/OCFA/RB6 PIC_PGC2 J2-5, ICSP 18 PGED2/AN7/RB7 PIC_PGD2 J2-4, ICSP 19 AVdd +3.3V --- 20 AVss Grounded 21 AN8/U2CTS/RB8 RB8 LCD SEG6 (G), U5-5 22 AN9/PMA7/RB9 RB9 LCD SEG7 (DP), U5-3 23 TMS/AN10/PMA13/RB10 UTIL_WP FLASH (U4) WP* 24 TDO/AN11/PMA12/RB11 UTIL_CS FLASH (U4) CS* 25 Vss Grounded 26 Vdd +3.3V --- 27 TCK/AN12/PMA11/RB12 N/C Not connected 28 TDI/AN13/PMA10/RB13 N/C Not connected 29 AN14/U2RTS/PMA1/RB14 temp_AD temp_AD 30 AN15/PMA0/CN12/RB15 PMPA0 Display, JP1-4, RS 31 SDA2/U2RX/PMA9/CN17/RF4 SDA LM75/SO, U3-1, SDA 32 SCL2/U2TX/PMA8/CN18/RF5 SCL LM75/SO, U3-2, SCL</p><p>*FLASH (U4, SOIC) not populated</p><p>RIGHT SIDE, TOP-TO-BOTTOM (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 48 SOSCO/T1CK/CN0/RC14 SOSCO 32.768KHz XTAL (Y1) 47 SOSCI/CN1/RC13 SOSCI 32.768KHz XTAL (Y1) 46 OC1/INT0/RD0 RD0 LCD DIG1, U5-12 45 IC4/PMCS1/PMA14/RD11 PMCS1 Display, JP1-6, E 44 SCL1/PMCS2/PMA15 RD10 LCD DIG2, U5-9 43 SDA1/RD9 RD9 LCD DIG3, U5-8 42 RTCC/RD8 RD8 LCD DIG4, U5-6 41 Vss Grounded 40 OSC2/CLKO/RC15 OSC2 20MHz XTAL (Y2) 39 OSC1/CLKI/RC12 OSC1 20MHz XTAL (Y2) 38 Vdd +3.3V --- 37 D+ MCU_D+ USB connectors via PHY 36 D- MCU_D- USB connectors via PHY 35 Vusb +3.3V --- 34 Vbus +5V_DUSB Display, USB Mini-B, USB Type A, JP1-1, +5V 33 USBID/RF3 N/C Not connected</p><p>TOP SIDE, LEFT-TO-RIGHT (if pin 1 is in upper left) PIN NAME SIGNAL NOTES ---- ----------------------------- -------------- ------------------------------- 64 PMPD4/RD4 PMPD4 Display, JP1-11, DB4 63 PMPD3/RD3 PMPD3 Display, JP1-10, DB3 62 PMPD2/RD2 PMPD2 Display, JP1-9, DB2 61 PMPD1/RD1 PMPD1 Display, JP1-8, DB1 60 PMPD0/RE0 PMPD0 Display, JP1-7, DB0 59 RF1 Key3 SW3-1 58 RF0 Key2 SW2-1 57 ENVREG ENVREG Pulled high 56 Vcap/Vddcore VDDCORE Capacitors to ground 55 CN16/RD7 N/C Not connected 54 CN15/RD6 Key5 SW5-1 53 PMRD/CN14/RD5 PMPRD --- 52 OC5/PMWR/CN13/RD4 PWM2 Used to control backlight level (Vo) 51 U1TX/OC4/RD3 N/C Not connected 50 U1RX/OC3/RD2 N/C Not connected 49 OC2/RD1 PWM1 Used to control backlight level (K)</p><h1 id="toolchains" tabindex="-1">Toolchains <a class="header-anchor" href="#toolchains" aria-label="Permalink to &quot;Toolchains&quot;">​</a></h1><p>MPLAB/C32 ---------</p><p>I am using the free, &quot;Lite&quot; version of the PIC32MX toolchain available for download from the microchip.com web site. I am using the Windows version. The MicroChip toolchain is the only toolchain currently supported in these configurations, but it should be a simple matter to adapt to other toolchains by modifying the Make.defs file include in each configuration.</p><p>C32 Toolchain Options:</p><pre><code>CONFIG_MIPS32_TOOLCHAIN_MICROCHIPW      - MicroChip full toolchain for Windows
...
</code></pre><h1 id="lcd1602" tabindex="-1">LCD1602 <a class="header-anchor" href="#lcd1602" aria-label="Permalink to &quot;LCD1602&quot;">​</a></h1><p>The on-board LCD is a 2x16 segment LCD and appears to be compatible with the LCD1602 and is treated like an LCD1602 LCD here.</p><p>LCD pin mapping</p><pre><code>--------------------- ---------- ----------------------------------
...
</code></pre><p>PIC32MXx specific device driver settings. NOTE: For the Sure board, UART2 is brought out to the DB9 connector and serves as the serial console.</p><pre><code>CONFIG_UARTn_SERIAL_CONSOLE - selects the UARTn for the
...
</code></pre><p>Where <code>&lt;subdir&gt;</code> is one of the following sub-directories.</p><p>NOTE: These configurations use the mconf-based configuration tool. To change any of these configurations using that tool, you should:</p><pre><code>a. Build and install the kconfig-mconf tool.  See nuttx/README.txt
   see additional README.txt files in the NuttX tools repository.

b. Execute &#39;make menuconfig&#39; in nuttx/ in order to start the
   reconfiguration process.
</code></pre><h2 id="configuration-sub-directories" tabindex="-1">Configuration sub-directories <a class="header-anchor" href="#configuration-sub-directories" aria-label="Permalink to &quot;Configuration sub-directories&quot;">​</a></h2><p>Where <code>&lt;subdir&gt;</code> is one of the following:</p><p>nsh: ==== Description. ------------ Configures the NuttShell (nsh) located at apps/examples/nsh. The Configuration enables only the serial NSH interface.</p><pre><code>Notes.
-----
...
</code></pre><p>usbnsh: ======= Description. ------------ This is another NSH example. If differs from the &#39;nsh&#39; configuration above in that this configurations uses a USB serial device for console I/O. This configuration was created to support the &quot;DB-DP11212 PIC32 General Purpose Demo Board&quot; which has no easily accessible serial port. However, as of this writing, the configuration has set for the &quot;DB_DP11215 PIC32 Storage Demo Board&quot; and has only be testing on that board.</p><pre><code>Notes.
-----
1. By default, this configuration uses an older Microchip C32 toolchain
   for Windows (the newer ones seem to be incompatible) and builds under
   Cygwin (or probably MSYS).  That can easily be reconfigured, of course.
...
</code></pre>`,77)]))}const I=n(a,[["render",r]]);export{d as __pageData,I as default};
