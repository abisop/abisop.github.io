import{_ as t,c as n,al as o,o as a}from"./chunks/framework.NFAqBSgQ.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"en/platforms/arm/sam34/boards/sam4s-xplained/README.md","filePath":"en/platforms/arm/sam34/boards/sam4s-xplained/README.md"}'),i={name:"en/platforms/arm/sam34/boards/sam4s-xplained/README.md"};function r(s,e,l,p,d,A){return a(),n("div",null,e[0]||(e[0]=[o(`<p>README ^^^^^^</p><p>This README discusses issues unique to NuttX configurations for the Atmel SAM4S Xplained development board. This board features the ATSAM4S16C MCU with 1MB FLASH and 128KB.</p><p>The SAM4S Xplained features:</p><pre><code>- 120 MHz Cortex-M4 with MPU
...
</code></pre><p>Thus if D9 is statically on, NuttX has successfully booted and is, apparently, running normmally. If D10 is flashing at approximately 2Hz, then a fatal error has been detected and the system has halted.</p><p>Serial Consoles ^^^^^^^^^^^^^^^</p><h2 id="uart1" tabindex="-1">UART1 <a class="header-anchor" href="#uart1" aria-label="Permalink to &quot;UART1&quot;">​</a></h2><p>If you have a TTL to RS-232 converter then this is the most convenient serial console to use. UART1 is the default in all of these configurations.</p><pre><code>UART1 RXD  PB2   J1 pin 3   J4 pin 3
...
</code></pre><p>CONFIG_ARCH_BOARD - Identifies the boards/ subdirectory and hence, the board that supports the particular chip or SoC.</p><pre><code>CONFIG_ARCH_BOARD=sam4s-xplained (for the SAM4S Xplained development board)
</code></pre><p>CONFIG_ARCH_BOARD_name - For use in C code</p><pre><code>CONFIG_ARCH_BOARD_SAM4S_XPLAINED=y
...
</code></pre><p>Configurations ^^^^^^^^^^^^^^</p><p>Each SAM4S Xplained configuration is maintained in a sub-directory and can be selected as follow:</p><pre><code>tools/configure.shsam4s-xplained:&lt;subdir&gt;
...
</code></pre>`,77)]))}const S=t(i,[["render",r]]);export{c as __pageData,S as default};
